...
- 기본 프로젝트에서 보안 기능 확장을 목표로 하여 개발 진행

 기존 프로젝트 링크: https://github.com/Lee-kangchan/EmotionProject
...
## 확장 기능
 ...
 - 암호화 방법 선택 ( 대칭키, 비대칭키 )
 - 사용자 활동 로그 기록
 - 추가 인증 방법 추가(패턴 인식, 질의 응답)
 - 위치 기반 이상 감지(스마트폰(ip), 컴퓨터(gps, ip))
 - 실시간 사용자(표정, 음성) 로그 기록 확인 
