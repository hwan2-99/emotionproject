!function (t, e) {
    ...
    function x(t, e) {
        if (void 0 === e && (e = []), null == e && (e = []), Array.isArray(t) || z(t)) for (var n = 0; n < t.length; ++n) x(t[n], e); else e.push(t);
        return e
    }
    ...
    var t = Object.freeze({
        ...
        return t.prototype.logKernelProfile = function (t, e, n, r, o) {
            var i = C(r + "ms", 9), a = C(t, 25), s = e.rank, u = e.size, c = C(e.shape.toString(), 14);
            console.log("%c" + a + "\t%c" + i + "\t%c" + s + "D " + c + "\t%c" + u + "\t%c" + o, "font-weight:bold", "color:red", "color:blue", "color: orange", "color: green")
        }, t
    }(), rt = 20, ot = 3, it = 7;

    function at(t, e, n, r) {
        var o = K(e), i = function (t, e, n, r) {
            var o = B(e), i = r[r.length - 1], a = new Array(i).fill(0), s = e.length,
                u = "complex64" === n ? ct(t) : t;
            if (1 < s) for (var c = 0; c < o / i; c++) for (var l = c * i, h = 0; h < i; h++) a[h] = Math.max(a[h], st(u[l + h], 0, n).length);
            return a
            ...
            if (1 === c) {
                if (rt < u) {
                    var l = ot * s, h = Array.from(e.slice(0, l)), p = Array.from(e.slice(u - ot * s, u));
            ...
            var f = n.slice(1), d = o.slice(1), v = o[0] * s, m = [];
            if (rt < u) {
                for (var g = 0; g < ot; g++) {
                    var y = (x = g * v) + v;
    ...
    function Dt(t) {
        var e = [];
        return function t(e, n, r) {
            if (null != e) if (e instanceof dt) n.push(e); else if (s = e, Array.isArray(s) || "object" == typeof s) {
                var o = e;
                for (var i in o) {
                    var a = o[i];
    ...
    var Mt, Ot, Pt = Object.freeze({
        makeTypesMatch: Tt, assertTypesMatch: At, isTensorInList: function (t, e) {
        ...
        return t.prototype.moveData = function (t) {
            ...
            var r, o = this, i = [], a = this.isTapeOn(), s = null != this.activeScope ? this.activeScope.name : "",
                u = function (t) {
                    a && (i = t.map(function (t) {
                        return o.keep(o.clone(t))
                    }))
                }, c = this.numBytes, l = this.numTensors;
            if (this.scopedRun(function () {
                ...
                var h = {id: this.nextTapeNodeId++, name: s, inputs: e, outputs: Array.isArray(r) ? r : [r], saved: i};
            ...
            return this.tidy("backward", function () {
                var t, e, n = {};
                n[s.id] = null == i ? (t = s.shape, e = Q(B(t), "float32"), dt.make(t, {values: e})) : i, function (a, s, u) {
                    for (var t = function (t) {
                        var o = s[t], r = [];
                        if (o.outputs.forEach(function (t) {
                            var e = a[t.id];
                            if (null != e) r.push(e); else {
                                var n = dt.make(t.shape, {values: J(t.size, t.dtype)}, t.dtype);
                                r.push(n)
                            }
                        }), null == o.gradient) throw new Error("Cannot compute gradient: gradient function not found for " + o.name + ".");
                        var i = o.gradient(1 === o.outputs.length ? r[0] : r), e = function (t) {
                ...
                }), a.activeTape = null), {value: s, grads: r}
            })
    ...
    var Lt, Bt, Wt = [{name: "DEBUG", type: Mt.BOOLEAN}, {name: "IS_BROWSER", type: Mt.BOOLEAN}, {
        ...
        type: Mt.NUMBER
    }, {name: "WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE", type: Mt.BOOLEAN}, {
        name: "WEBGL_VERSION",
        type: Mt.NUMBER
        ...
        type: Mt.NUMBER
    }, {name: "BACKEND", type: Mt.STRING}, {name: "EPSILON", type: Mt.NUMBER}, {
        name: "PROD",
        type: Mt.BOOLEAN
    ...
    function Ht(t, e) {
        var n = t.createFramebuffer(), r = t.createTexture();
    ...
    var qt, jt = function () {
        ...
        return t.setBackend = function (t, e) {
            ...
            try {
                ...
                }), this.registry[t] = {backend: o, priority: n}, this.registryFactory[t] = e, !0
            } catch (e) {
    ...
    function ie(t, e) {
        ...
        }), null == e) for (var n in e = [], Zt.engine.registeredVariables) e.push(Zt.engine.registeredVariables[n]);
        var r = e.length;
        ...
        var o = Zt.engine.gradients(t, e, null, !0), i = o.value, a = o.grads;
        D(a.some(function (t) {
            return null != t
        }), function () {
    ...
    var ue = jt.tidy, ce = jt.keep, le = jt.dispose, he = jt.time, pe = jt.profile;
    ...
    var Le = Fe({
        softmax_: function (t, o) {
            ...
            return ae(function (t, e) {
                var n = t.logSumExp([o], !0), r = t.toFloat().sub(n).exp();
                return e([r]), {
                    value: r, gradFunc: function (t, e) {
                        var n = e[0], r = t.mul(n);
    ...
    var We = Fe({
        complex_: function (t, e) {
            var n = re(t, "real", "complex"), r = re(e, "imag", "complex");
    ...
    function Ge(t, e, n) {
        ...
        if (null != e) {
            ...
            for (var a = 0; a < r.length; ++a) {
                var s = r[a], u = a !== r.length - 1 || s !== B(e.slice(a));
                D(r[a] === e[a] || !u, function () {
                    return "Error creating a new Tensor. Inferred shape (" + r + ") does not match the provided shape (" + e + "). "
                })
            }
        }
        return z(t) || Array.isArray(t) || (t = [t]), e = e || r, t = "string" !== n ? X(t, n, Zt.get("DEBUG")) : x(t), dt.make(e, {values: t}, n)
    }
    ...
    function Ye(t, e) {
        if (void 0 === e && (e = "float32"), "complex64" === e) {
            var n = Ye(t, "float32"), r = Ye(t, "float32");
            return We(n, r)
        }
        var o = Q(B(t), e);
    ...
    function Qe(t, e) {
        if (void 0 === e && (e = "float32"), "complex64" === e) {
            var n = Qe(t, "float32"), r = Qe(t, "float32");
            return We(n, r)
        }
        var o = J(B(t), e);
        return dt.make(t, {values: o}, e)
    ...
    function an(t, e, n) {
        if ("complex64" === e) {
            ...
            var r = Qe(t.shape), o = t.toFloat(), i = n.complex(o, r);
    ...
    function ln(t, e, n, r, o) {
        for (var i = Array.from(e).map(function (t, e) {
            ...
            var u = i[s], c = u.score, l = u.boxIndex;
            if (c < o) break;
            for (var h = !1, p = a.length - 1; 0 <= p; --p) if (hn(t, l, a[p]) >= r) {
                h = !0;
                break
            }
    ...
    function hn(t, e, n) {
        var r = t.subarray(4 * e, 4 * e + 4), o = t.subarray(4 * n, 4 * n + 4), i = Math.min(r[0], r[2]),
            ...
            l = Math.min(o[1], o[3]), h = Math.max(o[0], o[2]), p = Math.max(o[1], o[3]), f = (s - i) * (u - a),
            d = (h - c) * (p - l);
        if (f <= 0 || d <= 0) return 0;
        var v = Math.max(i, c), m = Math.max(a, l), g = Math.min(s, h), y = Math.min(u, p),
                ...
                return function (t, e, n) {
                    ...
                    return o.length <= i.length && (r += n ? function (t, e) {
                        var n, r = t.name, o = r.charAt(0).toUpperCase() + r.slice(1), i = "get" + o + "AtOutCoords",
                            ...
                            u = gn(t.shapeInfo.logicalShape, e.logicalShape), c = Dn(s), l = s - a,
                            h = ["x", "y", "z", "w", "u", "v"];
                        ...
                        if (1 === a && 1 < s) f = "\n      return vec4(outputValue.xy, outputValue.xy);\n    "; else if (0 === a && 0 < s) f = 1 === s ? "\n        return vec4(outputValue.x, outputValue.x, 0., 0.);\n      " : "\n        return vec4(outputValue.x);\n      "; else if (u.length) {
                            var d = a - 2, v = a - 1;
                            -1 < u.indexOf(d) && -1 < u.indexOf(v) ? f = "return vec4(outputValue.x);" : -1 < u.indexOf(d) ? f = "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);" : -1 < u.indexOf(v) && (f = "return vec4(outputValue.xx, outputValue.zz);")
                        }
                        ...
                        var c = Dn(u), l = gn(t.shapeInfo.logicalShape, e.logicalShape), h = u - s,
                            p = ["x", "y", "z", "w", "u", "v"];
    ...
    function Sn(t) {
        switch (t.shapeInfo.logicalShape.length) {
            ...
            case 2:
                return function (t) {
                    var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1),
                        o = t.shapeInfo.texShape, i = o[0], a = o[1], s = wn();
            ...
            case 3:
                return function (t) {
                    var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1),
                        o = t.shapeInfo.texShape, i = [Math.ceil(o[0] / 2), Math.ceil(o[1] / 2)];
                    if (1 === e[0]) return "\n        " + Sn(Mn(t, e.slice(1))) + "\n        vec4 " + r + "(int b, int row, int col) {\n          return " + r + "(" + On(["b", "row", "col"], [1, 2]) + ");\n        }\n      ";
                    var a = i[0], s = i[1], u = Math.ceil(e[2] / 2);
    ...
    function An(t) {
        var e = t.name, n = B(t.shapeInfo.logicalShape);
        return n < 2 ? "return " + e + ";" : "\n    for (int i = 0; i < " + n + "; i++) {\n      if (i == index) {\n        return " + e + "[i];\n      }\n    }\n  "
    }
    ...
    var Pn = function (t, e, n, r) {
            ...
            var a, s, u = this.outputShape, c = u.length, l = Dn(c), h = mn("coords", c);
            if (1 === i) {
                var p = Dn(s = c + 1);
                a = "\n        " + p + " sourceLocR = " + p + "(" + h.join() + ", 0);\n        ++" + h[c - 1] + ";\n        " + p + " sourceLocG = " + p + "(" + h.join() + ", 0);\n        ++" + h[c - 2] + ";\n        " + p + " sourceLocA = " + p + "(" + h.join() + ", 0);\n        --" + h[c - 1] + ";\n        " + p + " sourceLocB = " + p + "(" + h.join() + ", 0);\n        --" + h[c - 2] + ";"
            } else a = "\n        " + l + " sourceLocR = coords;\n        ++" + h[(s = c) - 1] + ";\n        " + l + " sourceLocG = coords;\n        ++" + h[c - 2] + ";\n        " + l + " sourceLocA = coords;\n        --" + h[c - 1] + ";\n        " + l + " sourceLocB = coords;\n        --" + h[c - 2] + ";";
            var f = ["x", "y", "z", "w", "u", "v"].slice(0, s), d = "." + f[s - 1], v = f.map(function (t) {
                    return "int " + t
                }), m = mn("sourceLocR", s - 1).concat("inIdx.r"), g = mn("sourceLocG", s - 1).concat("inIdx.g"),
                y = mn("sourceLocB", s - 1).concat("inIdx.b"), x = mn("sourceLocA", s - 1).concat("inIdx.a"),
        ...
        }, Wn = "return areal * breal - aimag * bimag;", zn = "return areal * bimag + aimag * breal;",
        Un = function (t, e, n) {
        ...
        }, Gn = "return a + b;", Vn = "return a - b;", Hn = "return a * b;", qn = "return (a - b) * (a - b);",
        jn = function (t, e, n) {
            ...
            var n = this.outputShape, r = n.length, o = Dn(r), i = mn("coords", r),
            ...
            var c = a[e], l = "vec2(" + a.slice(-2).join() + ")", h = a.join(),
            ...
            var e = t.padInfo.top, n = t.padInfo.left, r = t.strideHeight, o = t.strideWidth, i = t.dilationHeight,
                a = t.dilationWidth, s = t.filterHeight, u = t.filterWidth, c = 4 * Math.floor(t.inChannels / 4),
                l = t.inChannels % 4;
            ...
            var e = t.padInfo.front, n = t.padInfo.top, r = t.padInfo.left, o = t.strideDepth, i = t.strideHeight,
                ...
                h = t.filterHeight, p = t.filterWidth, f = 4 * Math.floor(t.inChannels / 4), d = t.inChannels % 4;
            ...
            this.variableNames = ["x", "W"], this.outputShape = t.outShape;
            var e = t.inHeight, n = t.inWidth, r = t.padInfo.top, o = t.padInfo.left, i = t.strideHeight, a = t.strideWidth,
                s = t.dilationHeight, u = t.dilationWidth, c = t.filterHeight, l = t.filterWidth,
            ...
            for (var e = t.inHeight, n = t.inWidth, r = t.padInfo.top, o = t.padInfo.left, i = t.strideHeight, a = t.strideWidth, s = t.dilationHeight, u = t.dilationWidth, c = t.filterHeight, l = t.filterWidth, h = l, p = "int xR; int xC; int xCOffset;", f = 0; f < c; f++) for (var d = 0; d < l; d++) p += "\n          vec4 xTexelR" + f + "C" + 2 * d + " = vec4(0.);\n          vec4 wR" + f + "C" + d + " = vec4(0.);\n          vec4 xR" + f + "C" + d + " = vec4(0.);";
            for (f = 0; f < c; f++) for (var v = 0; v < h; v++) {
                if (p += "\n          xR = xRCorner + " + f * s + ";\n          xC = xCCorner + " + (d = 2 * v) * u + ";\n        ", 1 === a) {
            ...
            for (f = 0; f < c; f++) for (d = 0; d < l; d++) p += "result += xR" + f + "C" + d + " * wR" + f + "C" + d + ";";
            this.userCode = "\n      const ivec2 strides = ivec2(" + i + ", " + a + ");\n      const ivec2 pads = ivec2(" + r + ", " + o + ");\n\n      void main() {\n\n        ivec4 coords = getOutputCoords();\n        int batch = coords.x;\n        ivec2 xRCCorner = coords.yz * strides - pads;\n        int d2 = coords.w;\n        int d1 = d2;\n        int q = 0;\n        int xRCorner = xRCCorner.x;\n        int xCCorner = xRCCorner.y;\n\n        vec4 result = vec4(0.);\n\n        " + p + "\n\n        setOutput(result);\n      }\n    "
        }, cr = function (t, e, n, r, o) {
            this.variableNames = ["Image", "Boxes", "BoxInd"], this.outputShape = [];
            var i = t[0], a = t[1], s = t[2], u = t[3], c = e[0], l = n[0], h = n[1];
            this.outputShape = [c, l, h, u];
            var p = "bilinear" === r ? 1 : 0, f = [a - 1 + ".0", s - 1 + ".0"], d = f[0], v = f[1],
    ...
    }, dr = "return real * expR - imag * expI;", vr = "return real * expI + imag * expR;", mr = function (t, e, n) {
    ...
    var wr, br, Er, Cr, _r = function (t, e, n) {
        ...
        var r = Dn(e.length), o = Dn(n.length), i = 1 < this.sliceDim ? "strides[j]" : "strides";
    ...
    function _o(t, e, n, r, o, i, a, s) {
        var u, c = Sr(r, o), l = c[0], h = c[1], p = r * o;
    ...
    function So(t, e, n, r, o, i, a, s, u, c) {
        var l = kr(a, s), h = l[0], p = l[1], f = new Float32Array(Ir(a, s));
        (function (t, e, n, r, o) {
    ...
    function No(t, e, n, r, o) {
        var i = t, a = new Float32Array(Rr(n * r, o.downloadUnpackNumChannels));
    ...
    function ko(t, e, n, r, o) {
        var i = Sr(n, r), a = i[0], s = i[1], u = new Float32Array(Rr(n * r, o.downloadUnpackNumChannels));
        Ar(t, e, function () {
    ...
    function Io(t, e, n, r, o) {
        var i = Sr(n, r), a = i[0], s = i[1], u = new Uint8Array(Rr(n * r, 4));
        return Ar(t, e, function () {
    ...
    function To(t, e, n, r, o, i, a, s) {
        var u = t, c = new Float32Array(Ir(i, a));
    ...
    function Ao(t, e, n, r, o, i, a, s) {
        var u = kr(i, a), c = u[0], l = u[1], h = new Float32Array(Ir(i, a));
        Ar(t, e, function () {
    ...
    var Do = Object.freeze({
        ...
        return Object.defineProperty(t.prototype, "debug", {
            ...
            this.throwIfDisposed();
            var e = this.gl, n = Fr(e, this.debug, t), r = lo(e, this.debug), o = Br(e, this.debug);
            ...
            var n = this;
            this.itemsToPoll.push({isDoneFn: t, resolveFn: e}), 1 < this.itemsToPoll.length || S(function () {
    ...
    var Po = function (t, e, n) {
        ...
        var r = n.filterWidth, o = n.inChannels, i = n.strideWidth, a = n.strideHeight, s = n.padInfo, u = n.outWidth,
            c = n.dilationWidth, l = n.dilationHeight, h = s.left, p = s.top, f = o * r, d = wn();
        ...
        var a = n ? t[1] : t[2], s = Math.ceil(a / 2), u = n ? "i * 2, rc.y" : "rc.y, i * 2",
            c = r ? "rc.z, i * 2" : "i * 2, rc.z", l = n ? ["a.xxyy", "a.zzww"] : ["a.xxzz", "a.yyww"],
            h = r ? ["b.xzxz", "b.ywyw"] : ["b.xyxy", "b.zwzw"], p = "", f = "";
        ...
        if (0 === i) this.userCode = "\n        void main() {\n          setOutput(vec4(getA(), 0., 0., 0.));\n        }\n      "; else {
            var a = mn("rc", i), s = Dn(i), u = function (t, e, n) {
                if (1 === t) return "rc > " + e[0];
                for (var r = "", o = t - 2; o < t; o++) r += n[o] + " >= " + e[o], o < t - 1 && (r += "||");
                return r
            }(i, t, a), c = function (t, e, n, r) {
                if (1 === t) return "";
                var o = r.slice(-2);
                return "\n    int r = " + o[0] + ";\n    int c = " + o[1] + ";\n    int rp1 = r + 1;\n    int cp1 = c + 1;\n\n    bool cEdge = cp1 >= " + e + ";\n    bool rEdge = rp1 >= " + n + ";\n  "
            }(i, t[t.length - 1], t[t.length - 2], a), l = (n = a, r = (e = t).length, o = function (t, e) {
    ...
    var Vo = function (n, t, e) {
        ...
        var r = n.length, o = Dn(r), i = t.map(function (t) {
            return t[0]
        ...
        this.userCode = "\n      \n    ivec3 inputCoordsFromReshapedOutCoords(int index) {\n      " + bn(["r", "c", "d"], e) + "\n      return ivec3(r, c, d);\n    }\n  \n      \n    int getFlatIndex(ivec3 coords) {\n      return round(" + function (t, e) {
            ...
            for (var n = [], r = Math.floor(t.length / 4), o = t.length % 4, i = 0; i < r; i++) {
                var a = t.slice(4 * i, 4 * i + 4), s = e.slice(4 * i, 4 * i + 4);
                n.push(En(a) + ", " + En(s))
            }
    ...
    var Ko = function (t, e, n) {
        ...
        var r = e.shape, o = r[1], i = r[2], a = t.shape, s = a[1], u = a[2],
            ...
            h = c[0] / l[0], p = c[1] / l[1], f = 1 / h, d = 1 / p, v = 2 * Math.ceil(f) + 2, m = 2 * Math.ceil(d) + 2;
        ...
        if (4 < t) throw new Error("WebGL backend: Reverse of rank-" + t + " tensor is not yet supported");
        this.outputShape = i;
        var e, n, r, o = mn("rc", t), s = o[t - 1] + " + 1 < " + this.outputShape[t - 1],
            u = o[t - 2] + " + 1 < " + this.outputShape[t - 2], c = Dn(t);
        ...
        var s = Dn(o.length), u = Dn(i.length), c = "";
        1 === n ? c = "i" : 2 === n && (c = "i, j");
        var l = "getIndices(" + c + ")", h = "";
        1 === r ? h = "i" : 2 === r && (h = "i, coords[1]");
        var p = "getUpdates(" + h + ")", f = 1 < e ? "strides[j]" : "strides";
        ...
        function t(t) {
            ...
            var e, n = Dn(this.rank), r = "uniform int start[" + this.rank + "];", o = function (t) {
    ...
    var ai = function () {
        function t(t) {
            ...
            var e = Dn(this.rank), n = mn("coords", this.rank), r = mn("sourceLoc", this.rank),
        ...
        this.outputShape = o;
        var i = n.length, a = Dn(n.length), s = Dn(o.length), u = "";
        if (1 === i) u = "coords * strides + begin"; else {
            var c = 0;
    ...
    var hi = function (t, e) {
        ...
        var o = Dn(this.rank), i = function (t) {
            var e = t.length;
    ...
    var fi = function (t, e) {
        ...
        var o = Dn(this.rank), i = vn("rc", this.rank), a = new Array(this.rank);
    ...
    }, di = 1.7580993408473768, vi = 1.0507009873554805, mi = function (t, e) {
        this.variableNames = ["A"], this.outputShape = t, this.userCode = "\n      float unaryOperation(float x) {\n        " + e + "\n      }\n\n      void main() {\n        float x = getAAtOutCoords();\n        float y = unaryOperation(x);\n\n        setOutput(y);\n      }\n    "
    }, gi = "if (isnan(x)) return x;", yi = gi + "\n  return (x < 0.0) ? 0.0 : x;\n";
    var xi = "return exp(x);", wi = "return x;",
        bi = "\n  vec4 result = x * vec4(greaterThanEqual(x, vec4(0.0)));\n  bvec4 isNaN = isnan(x);\n\n  result.r = isNaN.r ? x.r : result.r;\n  result.g = isNaN.g ? x.g : result.g;\n  result.b = isNaN.b ? x.b : result.b;\n  result.a = isNaN.a ? x.a : result.a;\n\n  return result;\n",
        Ei = function (t, e) {
            this.variableNames = ["A"], this.usesPackedTextures = !0, this.outputShape = t, this.userCode = "\n      vec4 unaryOperation(vec4 x) {\n        " + e + "\n      }\n\n      void main() {\n        vec4 x = getAAtOutCoords();\n        vec4 y = unaryOperation(x);\n\n        setOutput(y);\n      }\n    "
        }, Ci = function (t) {
            this.variableNames = ["A"], this.usesPackedTextures = !0;
            var e = (this.outputShape = t).length, n = mn("rc", e), r = Dn(e), o = function (t, e) {
                if (1 === t) return "rc";
    ...
    var Ai = Ti(function (t) {
        ...
        !function (s, u) {
            var c, l = this, h = 256, p = 6, f = "random", d = u.pow(h, p), v = u.pow(2, 52), m = 2 * v, g = h - 1;

            function t(t, e, n) {
                var r = [], o = x(function t(e, n) {
                    var r, o = [], i = typeof e;
    ...
    var Gi = Fe({
        batchToSpaceND_: function (t, e, n) {
            var r = re(t, "x", "batchToSpaceND"), o = e.reduce(function (t, e) {
                return t * e
            });
        ...
        cumsum_: function (t, e, n, r) {
            ...
            var o = re(t, "x", "cumsum"), i = Ce([e |= 0], o.rank), a = o;
            null != i && (a = o.transpose(i));
            var s = Se(1, o.rank)[0], u = Zt.engine.runKernel(function (t) {
        ...
        depthToSpace_: function (t, e, n) {
            void 0 === n && (n = "NHWC");
            var r = re(t, "x", "depthToSpace"), o = "NHWC" === n ? r.shape[1] : r.shape[2],
        ...
        multinomial_: function (t, e, n, r) {
            void 0 === r && (r = !1);
            var o = re(t, "logits", "multinomial"), i = o.size, a = o.rank;
            ...
            n = n || Math.random();
            var s = 1 === a ? o.as2D(1, -1) : o, u = Zt.engine.runKernel(function (t) {
        ...
        oneHot_: function (t, e, n, r) {
            ...
            var o = re(t, "indices", "oneHot", "int32"), i = o.shape.concat([e]);
    ...
    function fa(t, e) {
        ...
        var o = zi(t, "int32"), i = zi([n.length, t.length], "int32");
    ...
    var va = function () {
        ...
        return t.prototype.register = function (t, e, n) {
            ...
            var n = [t.height, t.width], r = [t.height, t.width, e];
            ...
            var i = new yr(r), a = this.compileAndRun(i, [o]);
            ...
            if (Zt.get("DEBUG")) for (var n = 0; n < e.length; n++) {
                var r = e[n];
                if (!Dr(r)) throw Error("The value " + r + " cannot be represented on this device.")
            }
            var o = this.texData.get(t), i = o.texture, a = o.texShape, s = o.usage, u = o.dtype, c = o.isPacked;
            ...
            if (null != i) {
                var s = new mi(a, wi), u = this.compileAndRun(s, [{dataId: t, shape: a, dtype: r}]),
            ...
            var t, n = this, r = this.texData.get(e), o = r.shape, i = r.dtype, a = r.texture, s = r.texShape, u = B(o);
            ...
            var f = ue(function () {
                    var t = new fr(o);
                    return n.compileAndRun(t, [{shape: o, dtype: i, dataId: e}], p, null, !1)
            ...
            if (!this.pendingDisposal.has(t)) if (this.pendingRead.has(t)) this.pendingDisposal.add(t); else if (this.texData.has(t)) {
                var e = this.texData.get(t), n = e.texture, r = e.dtype, o = e.texShape, i = e.usage,
                    a = e.complexTensors, s = e.isPacked, u = e.slice;
                if (null != n) {
                    var c = u && u.origDataId || t, l = this.dataRefCount.get(c);
            ...
            var r = this.texData.get(t.dataId).isPacked, o = Oe(t.shape, e, n);
            if (!r && o) return this.uploadToGPU(t.dataId), this.shallowSlice(t, e, n);
            var i = Zt.get("WEBGL_PACK_ARRAY_OPERATIONS") ? new ai(n) : new oi(n), a = i.getCustomSetupFunc(e);
            return this.compileAndRun(i, [t], null, a)
        }, t.prototype.shallowSlice = function (t, e, n) {
            var r = this.texData.get(t.dataId), o = dt.make(n, {}, t.dtype, this), i = this.texData.get(o.dataId);
            ...
            var c = Ae(t.shape, e, n, r, o, i, a, s, u), l = c[0], h = c[1], p = c[2], f = h.filter(function (t, e) {
            ...
            if (t.length > Zt.get("WEBGL_MAX_TEXTURES_IN_SHADER")) {
                var n = Math.floor(t.length / 2), r = this.concat(t.slice(0, n), e), o = this.concat(t.slice(n), e);
            ...
            var h = kt(t.dtype, e.dtype), p = new Wo(t.shape, [s, o, i], n, r),
                f = this.makePackedTensor(p.outputShape, h);
            return this.compileAndRun(p, [t, e], f)
        }, t.prototype.fusedBatchMatMul = function (t, e, n, r, o, i) {
            var a = n ? t.shape[2] : t.shape[1], s = r ? e.shape[1] : e.shape[2], u = t.shape[0],
                c = kt(t.dtype, e.dtype), l = new Wo(t.shape, [u, a, s], n, r, !!o, i ? function (t, e) {
                    if (void 0 === e && (e = !1), "linear" === t) return "return x;";
                    if ("relu" === t) return e ? bi : yi;
                    throw new Error("Activation " + t + " has not been implemented for the WebGL backend.")
                }(i, !0) : null), h = this.makePackedTensor(l.outputShape, c), p = [t, e];
            return o && p.push(o), this.compileAndRun(l, p, h)
        }, t.prototype.multiply = function (t, e) {
            if ("complex64" === t.dtype) {
                var n = this.texData.get(t.dataId), r = this.texData.get(e.dataId), o = new Un(Wn, t.shape, e.shape),
            ...
            var l = new jn(Hn, t.shape, e.shape), h = this.makeOutputArray(l.outputShape, t.dtype);
            ...
            var r = e.reduce(function (t, e) {
                    return t * e
                }), o = de(t.shape, e, r), i = ve(o.length, e.length), a = me(t.shape, e, r), s = ge(n, e.length),
                u = ye(a, n, e.length);
            ...
            var a = t.pad(o), s = de(a.shape, e, r, !1), u = ve(s.length, e.length, !1), c = me(a.shape, e, r, !1);
            return a.reshape(s).transpose(u).reshape(c)
        }, t.prototype.reduce = function (t, e, n) {
            var r = t.shape[0], o = t.shape[1], i = ke(o), a = new jo({windowSize: i, inSize: o, batchSize: r}, e),
                s = a.outputShape, u = s[0], c = s[1], l = this.makeOutputArray([u, c], n);
            ...
            var i = ke(o), a = new dn({windowSize: i, inSize: o, batchSize: r}, e, null == n), s = a.outputShape,
                u = s[0], c = s[1], l = this.makeOutputArray([u, c], "int32"), h = [t];
            ...
            void 0 === n && (n = null);
            var r = null != n ? n.shape : t.shape, o = ke(r[r.length - 1]), i = new Pn(r, o, e, null == n),
                a = this.makePackedTensor(i.outputShape, "int32"), s = null == n ? [t] : [t, n];
            return this.compileAndRun(i, s, a), a.rank === t.rank ? this.argReducePacked(t, e, a) : a
        }, t.prototype.sum = function (t, e) {
            Ee("sum", e, t.rank);
            var n = we(t.shape, e), r = n[0], o = B(n[1]), i = t.as2D(-1, o), a = It(t.dtype);
            ...
            var i = t.shape[0], a = t.shape[1], s = function (t, e) {
                    ...
                    return n
                }(a, o), u = new ni({windowSize: s, inSize: a, batchSize: i, numSegments: o}, e), c = u.outputShape,
                l = c[0], h = c[1], p = this.makeOutputArray([l, h], r);
            ...
            if (Ee("arg" + n.charAt(0).toUpperCase() + n.slice(1), r, t.rank), !Zt.get("WEBGL_PACK_REDUCE") || t.rank <= 2) {
                var o = we(t.shape, r), i = o[0], a = B(o[1]), s = t.as2D(-1, a);
            ...
            var n = new jn("return float(a == b);", t.shape, e.shape), r = this.makeOutputArray(n.outputShape, "bool");
            ...
            var r = new ri(t.rank, e.shape, e.rank), o = this.makeOutputArray(r.outputShape, kt(e.dtype, n.dtype));
            ...
            Ee("min", e, t.rank);
            var n = we(t.shape, e), r = n[0], o = B(n[1]), i = t.as2D(-1, o);
            ...
            var r = new jn(Gn, t.shape, e.shape), o = this.makeOutputArray(r.outputShape, n);
            return this.compileAndRun(r, [t, e], o)
        }, t.prototype.packedBinaryOp = function (t, e, n, r) {
            var o = new $n(n, t.shape, e.shape), i = this.makePackedTensor(o.outputShape, r);
            return this.compileAndRun(o, [t, e], i)
        }, t.prototype.complexSeparableBinaryOp = function (s, u, c) {
            var l = this, t = this.texData.get(s.dataId), e = this.texData.get(u.dataId),
                n = [[t.complexTensors.real, e.complexTensors.real], [t.complexTensors.imag, e.complexTensors.imag]].map(function (t) {
                    var e = t[0], n = t[1], r = l.makeComplexComponentTensorHandle(s, e),
                        o = l.makeComplexComponentTensorHandle(u, n), i = new jn(c, s.shape, u.shape),
            ...
            var r = new jn(Vn, t.shape, e.shape), o = this.makeOutputArray(r.outputShape, n);
            return this.compileAndRun(r, [t, e], o)
        }, t.prototype.pow = function (t, e) {
            ...
            var e = new mi(t.shape, "return float(isnan(x));"), n = this.makeOutputArray(e.outputShape, "bool");
            return this.compileAndRun(e, [t], n)
        }, t.prototype.isInf = function (t) {
            var e = new mi(t.shape, "return float(isinf(x));"), n = this.makeOutputArray(e.outputShape, "bool");
            return this.compileAndRun(e, [t], n)
        }, t.prototype.isFinite = function (t) {
            ...
            var e = new mi(t.shape, "return float(int(x));"), n = this.makeOutputArray(e.outputShape, "int32");
            return this.compileAndRun(e, [t], n)
        },t.prototype.clip = function (t, e, n) {
            ...
            var e = this.texData.get(t.dataId), n = new Yn(t.shape),
            ...
            var n,
                r = new mi(t.shape, (void 0 === (n = e) && (n = 0), gi + "\n    return x > 0.0 ? 1.0 : float(" + n + ");\n  "));
            return this.compileAndRun(r, [t])
        },t.prototype.conv2dByMatMul = function (t, e, n) {
            var r = t.shape, o = this.texData.get(t.dataId), i = n.inChannels, a = r[0] * r[1] * r[2],
                s = n.outChannels, u = (1 === a || 1 === s) && 1e3 < i, c = r[2] % 2 != 0 && !!o.isPacked;
            ...
            var p = dt.make([1, r[0] * r[1] * (r[2] + 1), n.inChannels], {dataId: t.dataId}, t.dtype, this),
                f = o.shape;
            ...
            var d = this.reshape(e, [1, n.inChannels, n.outChannels]), v = this.batchMatMul(p, d, !1, !1),
                m = this.texData.get(v.dataId);
            return D(m.isPacked, function () {
                return "batchMatMul result is expected to be packed"
            }), o.shape = f, m.shape = n.outShape, dt.make(n.outShape, {dataId: v.dataId}, v.dtype, this)
        },t.prototype.conv2dWithIm2Row = function (t, e, n) {
            var r = n.filterWidth, o = n.filterHeight, i = n.inChannels, a = n.outWidth, s = n.outHeight, u = r * o * i,
                c = s * a, l = [u, c], h = t.squeeze([0]), p = e.reshape([1, u, -1]), f = new Po(l, h.shape, n),
            ...
            var n = new qo(e, "max", !1), r = this.makeOutputArray(n.outputShape, t.dtype);
            return this.compileAndRun(n, [t], r)
        },t.prototype.avgPool = function (t, e) {
            var n = new qo(e, "avg", !1), r = this.makeOutputArray(n.outputShape, "float32");
            return this.compileAndRun(n, [t], r)
        },t.prototype.maxPoolBackprop = function (t, e, n, r) {
            var o = new qo(r, "max", !0), i = this.compileAndRun(o, [e]), a = new Bo(r),
                s = this.makeOutputArray(a.outputShape, e.dtype), u = this.compileAndRun(a, [t, i], s);
            return i.dispose(), u
        },t.prototype.avgPoolBackprop = function (t, e, n) {
            var r = new Fn(n), o = this.makeOutputArray(r.outputShape, e.dtype);
            ...
            var o = e ? t : Le(t), i = o.shape[0], a = o.shape[1], s = new zo(i, a, n),
            ...
            var r = Te(0, t, n), o = r.sliceRank, i = r.numUpdates, a = r.sliceSize, s = r.strides, u = r.outputSize,
                c = [u / a, a], l = t.reshape([i, o]), h = e.reshape([i, a]);
            if (0 === u) return sn(Ge([]), n);
            var p = Ve(0), f = new ei(i, o, l.rank, h.rank, s, c);
            return this.compileAndRun(f, [h, l, p]).reshape(n)
        },t.prototype.sparseToDense = function (t, e, n, r) {
            var o = Te(0, t, n), i = o.sliceRank, a = o.numUpdates, s = o.strides, u = o.outputSize,
            ...
            var n = this.texData.get(t.dataId), r = new mr(dr, t.shape, e), o = new mr(vr, t.shape, e),
            ...
            var n = e.shape, r = n[n.length - 1], o = Ne(t, e), i = o[0], a = o[1], s = o[2], u = o[3],
                c = e.reshape([a, r]), l = t.reshape([t.size / s, s]), h = new _r(r, u, [a, s]);
            ...
            var o = new gr(t, e), i = o.getCustomSetupFunc(e), a = this.makeOutputArray(t, n);
            ...
            var n = t.reshape([oo(t.shape)].concat(io(t.shape))), r = [oo(e)].concat(io(e)), o = new $o(r, n.shape);
            ...
            var s, u = {shape: e.shape, texData: this.texData.get(e.dataId), isUniform: !1}, c = function (t, e, n) {
                var r = "";
            ...
            }(o, a, u), l = this.getAndSaveBinary(c, function () {
                return function (t, r, e, n) {
                    var o = r.userCode, i = e.map(function (t, e) {
                        ...
                        flatOffset: null
                    }, u = Cn(i, s, o, r.usesPackedTextures), c = t.createProgram(u), l = null, h = null;
            ...
            h && (s = this.startTimer()), function (a, s, t, e, n) {
                ...
                e.texData.isPacked ? a.setOutputPackedMatrixTexture(r, o[0], o[1]) : a.setOutputMatrixTexture(r, o[0], o[1]), a.setProgram(s.webGLProgram), 1 === Zt.get("WEBGL_VERSION") && (null !== s.infLoc && a.gl.uniform1f(s.infLoc, 1 / 0), null !== s.nanLoc && a.gl.uniform1f(s.nanLoc, NaN)), t.forEach(function (t, e) {
                    ...
                    if (null != r) if (t.isUniform) if (B(t.shape) < 2) a.gl.uniform1f(r, t.uniformValues[0]); else {
            ...
            if (r && this.numBytesInGPU > p) for (var f = this.numBytesInGPU - p; 0 < f && 0 < this.lruDataGPU.length;) {
            ...
            var n = this.texData.get(t), r = n.texture, o = n.texShape, i = n.dtype, a = n.usage, s = n.isPacked;
    ...
    var ga = Fe({
        abs_: function (t) {
            ...
            }, {$x: r}) : Zt.engine.runKernel(function (t, e) {
                var n = t.abs(r);
                return e([r]), n
            }, {$x: r}, function (t, e) {
                var n = e[0];
    ...
    function Ja(t, e, n, r, o, i) {
        var a, s, u = re(t, "x", "batchNorm"), c = re(e, "mean", "batchNorm"), l = re(n, "variance", "batchNorm");
    ...
    function es(t, e, n, r, o, d) {
        null == d && (d = .001);
        var i, a, v, s = re(t, "x", "batchNorm"), u = re(e, "mean", "batchNorm"), c = re(n, "variance", "batchNorm");
        return null != o && (i = re(o, "scale", "batchNorm")), null != r && (a = re(r, "offset", "batchNorm")), D(u.rank === c.rank, function () {
            ...
            var e = t[0], r = t[1], o = t[2], i = t[3], a = null == i ? Ve(1) : i, s = yn(r.shape, v.shape), u = [];
            if (1 === r.rank) {
                for (var c = 0; c < v.shape.length - 1; ++c) u.push(v.shape[c]);
                u.push(1)
            }
            var l = e.sub(r), h = n.mul(a), p = Ba(o.add(Ve(d))), f = p.mul(p).mul(p).mul(Ve(-.5));
            return {
                $x: function () {
    ...
    var os = Fe({
        ...
        }), us = Fe({batchNorm_: es}), cs = Fe({batchNorm2d_: Ja}), ls = Fe({batchNorm3d_: Za}),
        hs = Fe({batchNorm4d_: ts});

    function ps(t, e, n, r, o, i, a) {
        void 0 === a && (a = "channelsLast");
        var s, u = vs(e), c = u[0], l = u[1];
    ...
    function fs(t, e, n, r, o, i, a, s) {
        ...
        var u = [-1, -1, -1, -1], c = u[0], l = u[1], h = u[2], p = u[3];
        ...
        var f, d = e[0], v = e[1], m = e[3], g = vs(n), y = g[0], x = g[1], w = vs(r), b = w[0], E = w[1], C = gs(d, b),
            _ = gs(v, E), S = function (t, e, n, r, o, i, a, s) {
                var u, c, l;
                if ("number" == typeof t) {
                    ...
                    var h = function (t, e, n, r, o, i) {
                        ...
                        var a = t[0], s = t[1], u = ys((a - e + 2 * o) / r + 1, i);
                        D(T(u), function () {
                    ...
                    var p = Math.max(0, (c - 1) * r + i - e), f = Math.max(0, (l - 1) * o + a - n), d = Math.floor(p / 2),
                        v = p - d, m = Math.floor(f / 2);
            ...
            }(o, l, h, y, x, C, _, i), R = S.padInfo, N = S.outHeight, k = S.outWidth, I = a ? m * p : m;
    ...
    function ds(t, e, n, r, o, i, a) {
        ...
        var s = [-1, -1, -1, -1, -1], u = s[0], c = s[1], l = s[2], h = s[3], p = s[4];
        if ("channelsLast" === a) u = t[0], c = t[1], l = t[2], h = t[3], p = t[4]; else {
            if ("channelsFirst" !== a) throw new Error("Unknown dataFormat " + a);
            u = t[0], p = t[1], c = t[2], l = t[3], h = t[4]
        }
        var f, d = e[0], v = e[1], m = e[2], g = e[4], y = ms(n), x = y[0], w = y[1], b = y[2], E = ms(r), C = E[0],
            _ = E[1], S = E[2], R = function (t, e, n, r, o, i, a, s, u, c) {
                var l, h, p, f;
                if ("same" === t) {
                    var d = ((h = Math.ceil(e / o)) - 1) * o + s - e, v = ((p = Math.ceil(n / i)) - 1) * i + u - n,
                        m = ((f = Math.ceil(r / a)) - 1) * a + c - r, g = Math.floor(d / 2), y = d - g,
                        x = Math.floor(v / 2), w = v - x, b = Math.floor(m / 2);
                    l = {top: x, bottom: w, left: b, right: m - b, front: g, back: y, type: "SAME"}
                } else {
                    if ("valid" !== t) throw Error("Unknown padding parameter: " + t);
                    l = {
                        top: 0,
            ...
            }(o, c, l, h, x, w, b, gs(d, C), gs(v, _), gs(m, S)), N = R.padInfo, k = R.outDepth, I = R.outHeight,
            T = R.outWidth, A = i ? g * p : g;
    ...
    function bs(t, e, r, o, i, a) {
        ...
        var h = fs(n, r.shape, o, 1, i, a), p = Zt.engine.runKernel(function (t, e) {
            var n = t.conv2dDerInput(s, r, h);
            return e([r, s]), n
        }, {dy4D: s, filter: r}, function (t, e) {
            var n = e[0], r = e[1];
            return {
                dy4D: function () {
    ...
    var _s = Fe({
        conv1d_: function (t, e, n, r, o, i, a) {
            ...
            var s = re(t, "x", "conv1d"), u = re(e, "filter", "conv1d"), c = s, l = !1;
            ...
            var h = u.as4D(1, u.shape[0], u.shape[1], u.shape[2]), p = c.as4D(c.shape[0], 1, c.shape[1], c.shape[2]),
        ...
        conv2d_: function (t, e, i, a, n, s, r) {
            ...
            var o = re(t, "x", "conv2d"), u = re(e, "filter", "conv2d"), c = o, l = !1;
            ...
            var h = fs(c.shape, u.shape, i, s, a, r), p = Zt.engine.runKernel(function (t, e) {
        ...
        conv3d_: function (t, e, o, i, n, a) {
            ...
            var r, s = re(t, "x", "conv3d"), u = re(e, "filter", "conv3d"), c = s, l = !1;
            ...
            var h = ds(c.shape, u.shape, o, a, i), p = Zt.engine.runKernel(function (t, e) {
                ...
                return {
                    x: function () {
                        return function (t, e, n, r, o) {
                            ...
                            var l = ds(i, n.shape, r, 1, o), h = Zt.engine.runKernel(function (t) {
    ...
    }), Ns = Fe({conv2dDerFilter_: Es}), ks = Fe({
        depthwiseConv2d_: function (t, e, n, r, o, i, a) {
            void 0 === o && (o = "NHWC"), void 0 === i && (i = [1, 1]);
            var s = re(t, "x", "depthwiseConv2d"), u = re(e, "filter", "depthwiseConv2d"), c = s, l = !1;
            ...
            var h = fs(c.shape, u.shape, n, i, r, a, !0), p = Zt.engine.runKernel(function (t, e) {
        ...
        separableConv2d_: function (t, e, n, r, o, i, a) {
            ...
            var s = re(t, "x", "separableConv2d"), u = re(e, "depthwiseFilter", "separableConv2d"),
                c = re(n, "pointwiseFilter", "separableConv2d"), l = s, h = !1;
            ...
            var d = ks(l, u, r, o, a, i), v = Ss(d, c, 1, "valid", a);
    ...
    var As = Fe({
        matMul_: function (t, e, i, a) {
            ...
            var r = re(t, "a", "matMul"), o = re(e, "b", "matMul");
            ...
            var s = i ? r.shape[r.rank - 2] : r.shape[r.rank - 1], u = a ? o.shape[o.rank - 1] : o.shape[o.rank - 2],
                ...
                h = r.shape.slice(0, -2), p = o.shape.slice(0, -2), f = B(h), d = B(p);
            ...
            var v = r.shape.slice(0, -2).concat([c, l]), m = i ? r.as3D(f, s, c) : r.as3D(f, c, s),
        ...
        dot_: function (t, e) {
            var n = re(t, "t1", "dot"), r = re(e, "t2", "dot");
        ...
        outerProduct_: function (t, e) {
            var n = re(t, "v1", "outerProduct"), r = re(e, "v2", "outerProduct");
    ...
    function Ws(t, o, i, a, s, e) {
        ...
        var c = ps(r.shape, o, i, a, s, e), l = Zt.engine.runKernel(function (t, e) {
            var n = t.maxPool(r, c);
            return e([r, n]), n
        }, {x: r}, function (t, e) {
            var n = e[0], r = e[1];
            return {
                x: function () {
                    return function (t, e, n, r, o, i, a, s) {
                        var u = re(t, "dy", "maxPoolBackprop"), c = re(e, "input", "maxPoolBackprop"),
    ...
    function zs(t, e, n, r, o, i) {
        ...
        var c = ps(s.shape, e, n, r, o, i), l = Zt.engine.runKernel(function (t) {
            return t.avgPool(s, c)
        }, {x: s}, function (t) {
            return {
                x: function () {
                    return function (t, e, n, r, o, i) {
                        var a = re(t, "dy", "avgPoolBackprop"), s = re(e, "input", "avgPoolBackprop");
                        ...
                        var h = ps(u.shape, n, r, o, i), p = Zt.engine.runKernel(function (t) {
    ...
    var Us = Fe({
        ...
        pool_: function (t, e, n, r, o, i) {
            ...
            var c, l, h, p, f, d, v = ps(s.shape, e, i, o, r), m = [v.dilationHeight, v.dilationWidth];
            ...
            var g, y, x, w, b, E, C, _, S = 1 === m[0] && 1 === m[1],
                R = (g = [v.inHeight, v.inWidth], y = m, w = (x = c).map(function (t) {
                    ...
                    return [0, C[e]]
                })]), N = R[1], k = S ? r : "valid", I = S ? s : aa(s, m, R[0]), T = ("avg" === n ? function () {
                    return zs(I, e, i, 1, k)
                } : function () {
                    return Ws(I, e, i, 1, k)
                })(), A = S ? T : Gi(T, m, N);
    ...
    var Ys = Fe({
        all_: function (t, e, n) {
            ...
            var r = re(t, "x", "all", "bool"), o = k(e, r.shape), i = o, a = Ce(i, r.rank);
        ...
        any_: function (t, e, n) {
            void 0 === e && (e = null), void 0 === n && (n = !1);
            var r = re(t, "x", "any", "bool"), o = k(e, r.shape), i = o, a = Ce(i, r.rank);
            null != a && (r = r.transpose(a), i = Se(i.length, r.rank));
            var s = Zt.engine.runKernel(function (t) {
                return t.any(r, i)
            }, {$x: r});
        ...
        argMax_: function (t, e) {
            ...
            var r = re(t, "x", "argMax");
            null == e && (e = 0);
            var o = k(e, r.shape), n = Ce(o, r.rank);
        ...
        logSumExp_: function (t, e, n) {
            void 0 === e && (e = null), void 0 === n && (n = !1);
            var r = re(t, "x", "logSumExp"), o = k(e, r.shape), i = r.max(o, !0), a = r.sub(i).exp().sum(o).log(),
        ...
        max_: function (t, e, n) {
            void 0 === e && (e = null), void 0 === n && (n = !1);
            var r = re(t, "x", "max"), o = r, i = k(e, r.shape), a = i, s = Ce(a, r.rank);
        ...
        mean_: function (t, e, r) {
            ...
            var n = re(t, "x", "mean"), o = k(e, n.shape), i = B(we(n.shape, o)[1]);
        ...
        min_: function (t, e, n) {
            void 0 === e && (e = null), void 0 === n && (n = !1);
            var r = re(t, "x", "min"), o = r, i = k(e, r.shape), a = i, s = Ce(a, r.rank);
            null != s && (r = r.transpose(s), a = Se(a.length, r.rank));
            var u = Zt.engine.runKernel(function (t, e) {
                var n = t.min(r, a);
                return e([o, n]), n
        ...
        moments_: function (t, e, n) {
            void 0 === e && (e = null), void 0 === n && (n = !1);
            var r = k(e, (t = re(t, "x", "moments")).shape), o = t.mean(r, n), i = o.shape;
            return n || (i = be(o.shape, r)), {mean: o, variance: t.toFloat().sub(o.reshape(i)).square().mean(r, n)}
        }
    }), iu = Fe({
        sum_: function (t, e, a) {
        ...
        prod_: function (t, e, n) {
            ...
            var o = k(e, r.shape), i = Ce(o, r.rank), a = o, s = r;
    ...
    var su = Fe({
        equal_: function (t, e) {
            var n, r = re(t, "a", "equal"), o = re(e, "b", "equal");
        ...
        equalStrict_: function (t, e) {
            var n = re(t, "a", "equalStrict"), r = re(e, "b", "equalStrict");
            return g(n.shape, r.shape, "Error in equalStrict: "), n.equal(r)
        }
    }), cu = Fe({
        greater_: function (t, e) {
            var n, r = re(t, "a", "greater"), o = re(e, "b", "greater");
            return n = Tt(r, o), r = n[0], o = n[1], xn(r.shape, o.shape), Zt.engine.runKernel(function (t) {
        ...
        greaterEqual_: function (t, e) {
            var n, r = re(t, "a", "greaterEqual"), o = re(e, "b", "greaterEqual");
        ...
        lessEqual_: function (t, e) {
            var n, r = re(t, "a", "lessEqual"), o = re(e, "b", "lessEqual");
            return n = Tt(r, o), r = n[0], o = n[1], xn(r.shape, o.shape), Zt.engine.runKernel(function (t) {
        ...
        notEqualStrict_: function (t, e) {
            var n = re(t, "a", "notEqualStrict"), r = re(e, "b", "notEqualStrict");
            return g(n.shape, r.shape, "Error in notEqualStrict: "), n.notEqual(r)
        }
    });
    var xu = Fe({
        add_: function (t, e) {
            var n, r = re(t, "a", "add"), o = re(e, "b", "add");
            n = Tt(r, o), r = n[0], o = n[1];
        ...
        addStrict_: function (t, e) {
            var n = re(t, "a", "addStrict"), r = re(e, "b", "addStrict");
            return g(n.shape, r.shape, "Error in addStrict: "), n.add(r)
        }
    }), Eu = Fe({
        atan2_: function (t, e) {
            var n, r = re(t, "a", "atan2"), o = re(e, "b", "atan2");
            n = Tt(r, o), r = n[0], o = n[1];
            ...
            return Zt.engine.runKernel(function (t, e) {
                ...
                return {
                    $a: function () {
                        var t = xu(o.square(), i.square()), e = r.mul(i.div(t)), n = yn(o.shape, a);
                        return 0 < n.length && (e = e.sum(n)), e.reshape(o.shape)
                    }, $b: function () {
                        var t = xu(o.square(), i.square()), e = Pa(r.mul(o.div(t))), n = yn(i.shape, a);
        ...
        div_: function (t, e) {
            var n, r = re(t, "a", "div"), o = re(e, "b", "div");
            ...
            return Zt.engine.runKernel(function (t, e) {
                ...
                return {
                    $a: function () {
                        var t = r.div(i.toFloat()), e = yn(o.shape, a);
                        return 0 < e.length ? t.sum(e).reshape(o.shape) : t
                    }, $b: function () {
                        var t = r.mul(o.toFloat()), e = yn(i.shape, a);
        ...
        maximum_: function (t, e) {
            var n, r = re(t, "a", "maximum"), o = re(e, "b", "maximum");
        ...
        maximumStrict_: function (t, e) {
            var n = re(t, "a", "maximumStrict"), r = re(e, "b", "maximumStrict");
            return g(n.shape, r.shape, "Error in maximumStrict: "), n.maximum(r)
        }
    }), ku = Fe({
        minimum_: function (t, e) {
            var n, r = re(t, "a", "minimum"), o = re(e, "b", "minimum");
            return n = Tt(r, o), r = n[0], o = n[1], "bool" === r.dtype && (r = r.toInt(), o = o.toInt()), xn(r.shape, o.shape), Zt.engine.runKernel(function (t, e) {
                var n = t.minimum(r, o);
                return e([r, o]), n
            }, {$a: r, $b: o}, function (t, e) {
        ...
        minimumStrict_: function (t, e) {
            var n = re(t, "a", "minimumStrict"), r = re(e, "b", "minimumStrict");
            return g(n.shape, r.shape, "Error in minimumStrict: "), n.minimum(r)
        }
    }), Tu = Fe({
        mod_: function (t, e) {
            var n, r = re(t, "a", "mod"), o = re(e, "b", "mod");
            n = Tt(r, o), r = n[0], o = n[1];
            var i = xn(r.shape, o.shape);
            return Zt.engine.runKernel(function (t, e) {
                var n = t.mod(r, o);
                ...
                return {
                    $a: function () {
                        ...
                        var t = n.mul(r.div(o).floor().neg()), e = yn(o.shape, i);
                        return 0 < e.length ? t.sum(e).reshape(o.shape) : t
                    }
                }
            })
        ...
        modStrict_: function (t, e) {
            var n = re(t, "a", "modStrict"), r = re(e, "b", "modStrict");
            return g(n.shape, r.shape, "Error in modStrict: "), n.mod(r)
        }
    }), Du = Fe({
        mul_: function (t, e) {
            var n, r = re(t, "a", "mul"), o = re(e, "b", "mul");
            n = Tt(r, o), r = n[0], o = n[1];
            var i = xn(r.shape, o.shape);
            return Zt.engine.runKernel(function (t, e) {
                ...
                return {
                    $a: function () {
                        var t = n.mul(o.toFloat()), e = yn(r.shape, i);
                        return 0 < e.length ? t.sum(e).reshape(r.shape) : t
                    }, $b: function () {
                        var t = n.mul(r.toFloat()), e = yn(o.shape, i);
                        return 0 < e.length ? t.sum(e).reshape(o.shape) : t
                    }
                }
            })
        ...
        mulStrict_: function (t, e) {
            var n = re(t, "a", "mul"), r = re(e, "b", "mul");
            return g(n.shape, r.shape, "Error in multiplyStrict: "), n.mul(r)
        }
    }), Ou = Fe({
        pow_: function (t, e) {
            var r = re(t, "base", "pow"), o = re(e, "exp", "pow"), u = xn(r.shape, o.shape);
            return t = r.cast(kt(r.dtype, o.dtype)), e = o.cast(kt(r.dtype, o.dtype)), Zt.engine.runKernel(function (t, e) {
                var n = t.pow(r, o);
                return e([r, o, n]), n
            }, {$base: r, $exp: o}, function (o, t) {
                var i = t[0], a = t[1], s = t[2];
                return {
                    $base: function () {
                        var t = a.toFloat(), e = o.mul(t.mul(i.pow(t.sub(Ve(1))))), n = yn(i.shape, u);
                        return 0 < n.length && (e = e.sum(n)), e.reshape(i.shape)
                    }, $exp: function () {
                        var t = i.greater(0), e = i.log().where(t, nn(i)), n = o.mul(s.mul(e)), r = yn(a.shape, u);
        ...
        squaredDifference_: function (t, e) {
            var n, r = re(t, "a", "squaredDifference"), o = re(e, "b", "squaredDifference");
            return n = Tt(r, o), r = n[0], o = n[1], xn(r.shape, o.shape), Zt.engine.runKernel(function (t, e) {
                var n = t.squaredDifference(r, o);
                return e([r, o]), n
            }, {$a: r, $b: o}, function (t, e) {
                var n = e[0], r = e[1], o = Ve(2);
                return {
                    $a: function () {
        ...
        squaredDifferenceStrict_: function (t, e) {
            var n = re(t, "a", "squaredDifferenceStrict"), r = re(e, "b", "squaredDifferenceStrict");
            return g(n.shape, r.shape, "Error in squaredDifferenceStrict: "), n.squaredDifference(r)
        }
    }), Bu = Fe({
        sub_: function (t, e) {
            var n, r = re(t, "a", "sub"), o = re(e, "b", "sub");
            n = Tt(r, o), r = n[0], o = n[1];
            var i = xn(r.shape, o.shape);
            return Zt.engine.runKernel(function (t) {
        ...
        subStrict_: function (t, e) {
            var n = re(t, "a", "subStrict"), r = re(e, "b", "subStrict");
            return g(n.shape, r.shape, "Error in subStrict: "), n.sub(r)
        }
    });
    var zu = Fe({
        logicalAnd_: function (t, e) {
            var n = re(t, "a", "logicalAnd", "bool"), r = re(e, "b", "logicalAnd", "bool");
        ...
        logicalOr_: function (t, e) {
            var n = re(t, "a", "logicalOr", "bool"), r = re(e, "b", "logicalOr", "bool");
            return xn(n.shape, r.shape), Zt.engine.runKernel(function (t) {
        ...
        logicalXor_: function (t, e) {
            var n = re(t, "a", "logicalXor", "bool"), r = re(e, "b", "logicalXor", "bool");
            return xn(n.shape, r.shape), Gu(t, e).logicalAnd(zu(t, e).logicalNot())
        }
    }), Hu = Fe({
        where_: function (t, e, n) {
            var r = re(e, "a", "where"), o = re(n, "b", "where"), i = re(t, "condition", "where", "bool");
    ...
    var ju = Fe({
        ...
        prelu_: function (t, e) {
            var r = re(t, "x", "prelu"), o = re(e, "alpha", "prelu");
            return Zt.engine.runKernel(function (t, e) {
                var n = t.prelu(r, o);
                return e([r, o]), n
                ...
                return {
                    $x: function () {
                        ...
                        var t = Hu(i, nn(n), n.mul(r)), e = yn(o.shape, n.shape);
                        return 0 < e.length && (t = t.sum(e)), t.reshape(o.shape)
                    }
                }
            })
        ...
        selu_: function (t) {
            ...
            return Zt.engine.runKernel(function (t, e) {
                ...
                return {
                    $x: function () {
                        var t = a.greater(Ve(0)), e = Ve(di), n = Ve(vi), r = i.mul(n),
    ...
    var nc = Fe({
        gather_: function (t, e, g) {
            void 0 === g && (g = 0);
            var y = re(t, "x", "gather"), r = re(e, "indices", "gather", "int32");
            g = k(g, y.shape)[0];
                ...
                return {
                    $x: function () {
                        var t = y.shape, e = m.size, n = t.slice(0, g), r = n.length, o = t.slice(g, t.length).slice(1),
                            i = o.length, a = tc(0, r), s = tc(r + 1, r + 1 + i), u = ec([n, [e], o]), c = v.reshape(u),
                            l = m.reshape([e]), h = ec([[r], a, s]), p = c.transpose(h), f = rc(p, l, y.shape[g]),
                            d = _e(h);
        ...
        unsortedSegmentSum_: function (t, e, r) {
            var o = re(t, "x", "unsortedSegmentSum"), i = re(e, "segmentIds", "unsortedSegmentSum", "int32");
    ...
    var oc = Fe({
        basicLSTMCell_: function (t, e, n, r, o, i) {
            var a = re(t, "forgetBias", "basicLSTMCell"), s = re(e, "lstmKernel", "basicLSTMCell"),
                u = re(n, "lstmBias", "basicLSTMCell"), c = re(r, "data", "basicLSTMCell"),
                l = re(o, "c", "basicLSTMCell"), h = re(i, "h", "basicLSTMCell"), p = c.concat(h, 1).matMul(s).add(u),
                f = p.shape[0], d = p.shape[1] / 4, v = [f, d], m = p.slice([0, 0], v), g = p.slice([0, d], v),
                y = p.slice([0, 2 * d], v), x = p.slice([0, 3 * d], v),
    ...
    var ac = Fe({
        movingAverage_: function (t, e, n, r, o) {
            void 0 === o && (o = !0);
            var i = re(t, "v", "movingAverage"), a = re(e, "x", "movingAverage"), s = re(n, "decay", "movingAverage");
            At(i, a), D(E(i.shape, a.shape), function () {
                return "Shape mismatch in v and x"
            });
            var u = Ve(1), c = u.sub(s), l = a.sub(i).mul(c);
            if (o) {
                D(null != r, function () {
    ...
    var sc = Fe({
        stridedSlice_: function (t, e, n, r, o, i, a, s, u) {
            ...
            if (r.every(function (t) {
                ...
                var l = Ae(c.shape, e, n, r, o, i, a, s, u), h = l[0], p = l[1], f = l[2],
    ...
    var cc = Fe({
        scatterND_: function (t, e, n) {
            var r = re(t, "indices", "scatterND", "int32"), o = re(e, "updates", "scatterND");
    ...
    var lc = Fe({
        ...
        rfft_: function (t) {
            ...
            var e = t.shape[t.shape.length - 1], n = t.size / e, r = t.zerosLike(), o = We(t, r).as2D(n, e), i = lc(o),
                a = Math.floor(e / 2) + 1, s = ze(i), u = Ue(i), c = s.split([a, e - a], s.shape.length - 1),
                l = u.split([a, e - a], u.shape.length - 1), h = t.shape.slice();
        ...
        irfft_: function (t) {
            ...
            if (e <= 2) {
                var r = t.as2D(n, e), o = hc(r);
                return ze(o)
            }
            var i = [n, 2 * (e - 1)], a = ze(t).as2D(n, e), s = Ue(t).as2D(n, e),
                u = a.slice([0, 1], [n, e - 2]).reverse(1), c = s.slice([0, 1], [n, e - 2]).reverse(1).mul(Ve(-1)),
    ...
    var vc = Fe({
        sparseToDense_: function (t, e, n, r) {
            void 0 === r && (r = 0);
            var o = re(t, "sparseIndices", "sparseToDense", "int32"), i = re(e, "sparseValues", "sparseToDense"),
    ...
    var mc, gc, yc = Fe({
        gatherND_: function (t, e) {
            var n = re(e, "indices", "gatherND", "int32"), r = re(t, "x", "gatherND");
            return Zt.engine.runKernel(function (t) {
    ...
    var xc = Fe({
        absoluteDifference_: function (t, e, n, r) {
            ...
            var o = re(t, "labels", "absoluteDifference"), i = re(e, "predictions", "absoluteDifference"), a = null;
        ...
        computeWeightedLoss_: function (t, e, n) {
            ...
            var r = re(t, "losses", "computeWeightedLoss"), o = null;
        ...
        cosineDistance_: function (t, e, n, r, o) {
            ...
            var i = re(t, "labels", "cosineDistance"), a = re(e, "predictions", "cosineDistance"), s = null;
        ...
        hingeLoss_: function (t, e, n, r) {
            void 0 === r && (r = mc.SUM_BY_NONZERO_WEIGHTS);
            var o = re(t, "labels", "hingeLoss"), i = re(e, "predictions", "hingeLoss"), a = null;
        ...
        huberLoss_: function (t, e, n, r, o) {
            ...
            var i = re(t, "labels", "huberLoss"), a = re(e, "predictions", "huberLoss"), s = null;
            null != n && (s = re(n, "weights", "huberLoss")), g(i.shape, a.shape, "Error in huberLoss: ");
            var u = Ve(r), c = a.sub(i).abs(), l = ku(c, u), h = c.sub(l), p = Ve(.5).mul(l.square()).add(u.mul(h));
            return wc(p, s, o)
        }
    }), _c = Fe({
        logLoss_: function (t, e, n, r, o) {
            void 0 === r && (r = 1e-7), void 0 === o && (o = mc.SUM_BY_NONZERO_WEIGHTS);
            var i = re(t, "labels", "logLoss"), a = re(e, "predictions", "logLoss"), s = null;
            null != n && (s = re(n, "weights", "logLoss")), g(i.shape, a.shape, "Error in logLoss: ");
            var u = Ve(1), c = Ve(r), l = i.mul(a.add(c).log()).neg().sub(u.sub(i).mul(u.sub(a).add(c).log()));
            return wc(l, s, o)
        }
    }), Sc = Fe({
        meanSquaredError_: function (t, e, n, r) {
            void 0 === r && (r = mc.SUM_BY_NONZERO_WEIGHTS);
            var o = re(t, "labels", "meanSquaredError"), i = re(e, "predictions", "meanSquaredError"), a = null;
        ...
        sigmoidCrossEntropy_: function (t, e, n, r, o) {
            ...
            var i = re(t, "multiClassLabels", "sigmoidCrossEntropy"), a = re(e, "logits", "sigmoidCrossEntropy"),
                s = null;
            if (null != n && (s = re(n, "weights", "sigmoidCrossEntropy")), g(i.shape, a.shape, "Error in sigmoidCrossEntropy: "), 0 < r) {
                var u = Ve(r), c = Ve(1), l = Ve(.5);
        ...
        softmaxCrossEntropy_: function (t, e, n, r, o) {
            void 0 === r && (r = 0), void 0 === o && (o = mc.SUM_BY_NONZERO_WEIGHTS);
            var i = re(t, "onehotLabels", "softmaxCrossEntropy"), a = re(e, "logits", "softmaxCrossEntropy"), s = null;
            if (null != n && (s = re(n, "weights", "softmaxCrossEntropy")), g(i.shape, a.shape, "Error in softmaxCrossEntropy: "), 0 < r) {
                var u = Ve(r), c = Ve(1), l = Ve(i.shape[1]);
                ...
                return ae(function (t, e, n) {
                    ...
                    return n([t, o]), {
                        value: o.mul(t).neg().sum([i]), gradFunc: function (t, e) {
                            var n = e[0], r = e[1], o = be(t.shape, [i]);
    ...
    function Ic(r, o) {
        return void 0 === o && (o = !1), Zt.engine.tidy(function () {
            ...
            for (var h = r.shape[0], p = r.shape[1], f = Ki(h), d = r.clone(), v = qe([[1]], [1, 1]), m = v.clone(), t = p <= h ? p : h, e = function (l) {
                var t, e = d, n = m, r = f;
                m = (t = Zt.engine.tidy(function () {
                    var t = d.slice([l, l], [h - l, 1]), e = t.norm(), n = d.slice([l, l], [1, 1]), r = n.sign().neg(),
                        o = n.sub(r.mul(e)), i = t.div(o);
                    m = 1 === i.shape[0] ? v.clone() : v.concat(i.slice([1, 0], [i.shape[0] - 1, i.shape[1]]), 0);
                    var a = r.matMul(o).div(e).neg(), s = d.slice([l, 0], [h - l, p]), u = a.mul(m);
    ...
    var Oc = Fe({
        resizeBilinear_: function (t, e, r) {
            ...
            var a = e[0], s = e[1], u = Zt.engine.runKernel(function (t, e) {
        ...
        nonMaxSuppression_: function (t, e, n, r, o) {
            ...
            var i = re(t, "boxes", "nonMaxSuppression"), a = re(e, "scores", "nonMaxSuppression"),
                s = Mc(i, a, n, r, o);
        ...
        cropAndResize_: function (t, e, n, r, o, i) {
            var a = re(t, "image", "cropAndResize", "float32"), s = re(e, "boxes", "cropAndResize", "float32"),
    ...
    var zc = Fe({
        matMul_: function (t, e, s, u, c, l) {
            ...
            var r = re(t, "a", "fused matMul"), o = re(e, "b", "fused matMul");
            n = Tt(r, o), r = n[0], o = n[1];
            var i = s ? r.shape[r.rank - 2] : r.shape[r.rank - 1], a = u ? o.shape[o.rank - 1] : o.shape[o.rank - 2],
                h = s ? r.shape[r.rank - 1] : r.shape[r.rank - 2], p = u ? o.shape[o.rank - 2] : o.shape[o.rank - 1],
                f = r.shape.slice(0, -2), d = o.shape.slice(0, -2), v = B(f), m = B(d);
            D(2 <= r.rank && 2 <= o.rank && r.rank === o.rank, function () {
            ...
            var g, y = r.shape.slice(0, -2).concat([h, p]), x = s ? r.as3D(v, i, h) : r.as3D(v, h, i),
            ...
            return null != c && (b.$bias = g), Zt.engine.runKernel(function (t, e) {
                ...
                var n, r = e[0], o = e[1], i = e[2];
                if (null == l || "linear" === l) n = t; else {
    ...
    }), Uc = Object.freeze({matMul: zc}), Gc = Object.freeze({
        image: Wc,
        linalg: Dc,
        losses: kc,
        spectral: dc,
    ...
    var Vc = function () {
        ...
        return t.prototype.setDataMover = function (t) {
            ...
            if (null != t.getContext) n = t.getContext("2d").getImageData(0, 0, t.width, t.height).data; else if (t instanceof ImageData) n = t.data; else {
            ...
            if (4 === e) r = new Int32Array(n); else {
                ...
                for (var i = 0; i < o; i++) for (var a = 0; a < e; ++a) r[i * e + a] = n[4 * i + a]
            }
            ...
            if (1 === e[0].shape[0]) {
                ...
                var u = 0;
                e.forEach(function (t) {
                    for (var e = t.dataSync(), n = 0, r = 0; r < t.shape[0]; ++r) for (var o = r * a[1] + u, i = 0; i < t.shape[1]; ++i) s[o + i] = e[n++];
                    u += t.shape[1]
                })
            }
            ...
            for (var e = t.map(function (t) {
                return t.dataSync()
            }), n = zi(t[0].shape, t[0].dtype), r = n.values, o = 0; o < t.length; o++) for (var i = e[o], a = 0; a < r.length; a++) r[a] += i[a];
            return n.toTensor()
        }, t.prototype.subtract = function (t, e) {
            return "complex64" === t.dtype || "complex64" === e.dtype ? this.broadcastedBinaryComplexOp(t.cast("complex64"), e.cast("complex64"), function (t, e, n, r) {
                return {real: t - n, imag: e - r}
            ...
            for (i = 0; i < n; ++i) {
                var a = Ve(i, "int32"), s = su(a, e).asType("float32").mul(t).sum(0);
                r.push(s)
            }
            return ua(r)
        }, t.prototype.argMin = function (t, e) {
            ...
            for (var r = t.dataSync(), o = e.dataSync(), i = n.dataSync(), a = Qe(e.shape, kt(e.dtype, n.dtype)), s = a.dataSync(), u = 0, c = 0 === t.rank || 1 < t.rank || 1 === e.rank ? 1 : e.shape[1], l = 0; l < r.length; l++) for (var h = 0; h < c; h++) 1 === r[l] ? s[u++] = o[l] : s[u++] = i[l];
            return a
        }, t.prototype.where = function (t) {
            ...
            for (var r = n.filterHeight, o = n.filterWidth, i = n.dilationHeight, a = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = zi(n.outShape, t.dtype), l = t.dataSync(), h = e.dataSync(), p = c.values, f = 0; f < n.batchSize; ++f) for (var d = f * t.strides[0], v = f * c.strides[0], m = 0; m < n.outHeight; ++m) for (var g = v + m * c.strides[1], y = m * n.strideHeight - s, x = 0; x < r; x++) {
                var w = y + x * i;
                if (!(w < 0 || w >= n.inHeight)) for (var b = x * e.strides[0], E = d + w * t.strides[1], C = 0; C < n.outWidth; ++C) for (var _ = g + C * n.outChannels, S = C * n.strideWidth - u, R = 0; R < o; R++) {
                    var N = S + R * a;
                    if (!(N < 0 || N >= n.inWidth)) for (var k = b + R * e.strides[1], I = E + N * n.inChannels, T = k, A = 0; A < n.inChannels; ++A) {
            ...
            for (var r = n.filterDepth, o = n.filterHeight, i = n.filterWidth, a = n.dilationDepth, s = n.dilationHeight, u = n.dilationWidth, c = n.padInfo.front, l = n.padInfo.left, h = n.padInfo.top, p = zi(n.outShape, t.dtype), f = t.dataSync(), d = e.dataSync(), v = p.values, m = 0; m < n.batchSize; ++m) for (var g = m * t.strides[0], y = m * p.strides[0], x = 0; x < n.outDepth; ++x) for (var w = y + x * p.strides[1], b = x * n.strideDepth - c, E = 0; E < r; E++) {
                var C = b + E * a;
                if (!(C < 0 || C >= n.inDepth)) for (var _ = E * e.strides[0], S = g + C * t.strides[1], R = 0; R < n.outHeight; ++R) for (var N = w + R * p.strides[2], k = R * n.strideHeight - h, I = 0; I < o; I++) {
                    var T = k + I * s;
                    if (!(T < 0 || T >= n.inHeight)) for (var A = _ + I * e.strides[1], D = S + T * t.strides[2], M = 0; M < n.outWidth; ++M) for (var O = N + M * n.outChannels, P = M * n.strideWidth - l, F = 0; F < i; F++) {
                        var L = P + F * u;
                        if (!(L < 0 || L >= n.inWidth)) for (var B = A + F * e.strides[2], W = D + L * n.inChannels, z = B, U = 0; U < n.inChannels; ++U) {
            ...
            for (var r = zi(n.inShape, "float32"), o = r.values, i = r.strides, a = i[0], s = i[1], u = i[2], c = i[3], l = t.dataSync(), h = t.strides, p = h[0], f = h[1], d = h[2], v = h[3], m = e.dataSync(), g = e.strides, y = g[0], x = g[1], w = g[2], b = g[3], E = n.batchSize, C = n.filterDepth, _ = n.filterHeight, S = n.filterWidth, R = n.inChannels, N = n.inDepth, k = n.inHeight, I = n.inWidth, T = n.outChannels, A = n.outDepth, D = n.outHeight, M = n.outWidth, O = n.strideDepth, P = n.strideHeight, F = n.strideWidth, L = C - 1 - n.padInfo.front, B = _ - 1 - n.padInfo.top, W = S - 1 - n.padInfo.left, z = 0; z < E; ++z) for (var U = 0; U < R; ++U) for (var G = 0; G < N; ++G) for (var V = G - L, H = Math.max(0, Math.ceil(V / O)), q = Math.min(A, (C + V) / O), j = 0; j < k; ++j) for (var $ = j - B, K = Math.max(0, Math.ceil($ / P)), X = Math.min(D, (_ + $) / P), Y = 0; Y < I; ++Y) {
                for (var Q = Y - W, J = Math.max(0, Math.ceil(Q / F)), Z = Math.min(M, (S + Q) / F), tt = 0, et = H; et < q; ++et) for (var nt = et * O - V, rt = K; rt < X; ++rt) for (var ot = rt * P - $, it = J; it < Z; ++it) for (var at = p * z + f * et + d * rt + v * it, st = y * (C - 1 - nt) + x * (_ - 1 - ot) + w * (S - 1 - (it * F - Q)) + b * U, ut = 0; ut < T; ++ut) tt += l[at + ut] * m[st + ut];
                o[a * z + s * G + u * j + c * Y + U] = tt
            }
            return r.toTensor()
        }, t.prototype.conv2dDerFilter = function (t, e, n) {
            this.assertNotComplex([t, e], "conv2dDerFilter");
            for (var r = n.strideHeight, o = n.strideWidth, i = n.filterHeight, a = n.filterWidth, s = zi(n.filterShape, "float32"), u = n.padInfo.left, c = n.padInfo.top, l = t.bufferSync(), h = e.bufferSync(), p = 0; p < i; ++p) for (var f = Math.max(0, Math.ceil((c - p) / r)), d = Math.min(n.outHeight, (n.inHeight + c - p) / r), v = 0; v < a; ++v) for (var m = Math.max(0, Math.ceil((u - v) / o)), g = Math.min(n.outWidth, (n.inWidth + u - v) / o), y = 0; y < n.inChannels; ++y) for (var x = 0; x < n.outChannels; ++x) {
                for (var w = 0, b = 0; b < n.batchSize; ++b) for (var E = f; E < d; ++E) for (var C = p + E * r - c, _ = m; _ < g; ++_) {
                    var S = v + _ * o - u;
            ...
            for (var r = n.filterHeight, o = n.filterWidth, i = n.dilationHeight, a = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = n.outChannels / n.inChannels, l = zi(n.outShape, t.dtype), h = t.dataSync(), p = e.dataSync(), f = l.values, d = 0; d < n.batchSize; ++d) for (var v = d * t.strides[0], m = d * l.strides[0], g = 0; g < n.outHeight; ++g) for (var y = m + g * l.strides[1], x = g * n.strideHeight - s, w = 0; w < r; ++w) {
                var b = x + w * i;
                if (!(b < 0 || b >= n.inHeight)) for (var E = w * e.strides[0], C = v + b * t.strides[1], _ = 0; _ < n.outWidth; ++_) for (var S = y + _ * l.strides[2], R = _ * n.strideWidth - u, N = 0; N < o; ++N) {
                    var k = R + N * a;
                    if (!(k < 0 || k >= n.inWidth)) for (var I = E + N * e.strides[1], T = C + k * n.inChannels, A = S, D = I, M = 0; M < n.inChannels; ++M) {
            ...
            for (var r = zi(n.inShape, "float32"), o = r.values, i = r.strides, a = i[0], s = i[1], u = i[2], c = t.dataSync(), l = t.strides, h = l[0], p = l[1], f = l[2], d = e.dataSync(), v = e.strides, m = v[0], g = v[1], y = v[2], x = n.batchSize, w = n.filterHeight, b = n.filterWidth, E = n.inChannels, C = n.inHeight, _ = n.inWidth, S = n.outChannels, R = n.outHeight, N = n.outWidth, k = n.strideHeight, I = n.strideWidth, T = w - 1 - n.padInfo.top, A = b - 1 - n.padInfo.left, D = S / E, M = 0; M < x; ++M) for (var O = 0; O < E; ++O) for (var P = 0; P < C; ++P) for (var F = P - T, L = Math.max(0, Math.ceil(F / k)), B = Math.min(R, (w + F) / k), W = 0; W < _; ++W) {
                for (var z = W - A, U = Math.max(0, Math.ceil(z / I)), G = Math.min(N, (b + z) / I), V = 0, H = L; H < B; ++H) for (var q = H * k - F, j = U; j < G; ++j) for (var $ = h * M + p * H + f * j, K = m * (w - 1 - q) + g * (b - 1 - (j * I - z)) + y * O, X = 0; X < D; ++X) V += c[$ + (O * D + X)] * d[K + X];
                o[a * M + s * P + u * W + O] = V
            }
            return r.toTensor()
        },t.prototype.depthwiseConv2DDerFilter = function (t, e, n) {
            ...
            for (var r = n.strideHeight, o = n.strideWidth, i = n.filterHeight, a = n.filterWidth, s = zi(n.filterShape, "float32"), u = n.padInfo.left, c = n.padInfo.top, l = n.outChannels / n.inChannels, h = t.bufferSync(), p = e.bufferSync(), f = 0; f < i; ++f) for (var d = Math.max(0, Math.ceil((c - f) / r)), v = Math.min(n.outHeight, (n.inHeight + c - f) / r), m = 0; m < a; ++m) for (var g = Math.max(0, Math.ceil((u - m) / o)), y = Math.min(n.outWidth, (n.inWidth + u - m) / o), x = 0; x < n.outChannels; ++x) {
                for (var w = Math.trunc(x / l), b = x % l, E = 0, C = 0; C < n.batchSize; ++C) for (var _ = d; _ < v; ++_) for (var S = f + _ * r - c, R = g; R < y; ++R) {
                    var N = m + R * o - u;
            ...
            var o = zi(n, t.dtype), i = t.bufferSync();
            ...
            var o = t.dataSync(), i = zi(n, t.dtype), a = t.bufferSync();
            for (r = 0; r < t.size; ++r) {
            ...
            var r = t.shape.slice(), o = e.dataSync();
            r[n] = o.length;
            ...
            for (var n = zi(e.outShape, "int32"), r = e.strideHeight, o = e.strideWidth, i = e.dilationHeight, a = e.dilationWidth, s = e.effectiveFilterHeight, u = e.effectiveFilterWidth, c = e.padInfo.top, l = e.padInfo.left, h = t.bufferSync(), p = 0; p < e.batchSize; ++p) for (var f = 0; f < e.inChannels; ++f) for (var d = 0; d < e.outHeight; ++d) {
                for (var v = d * r - c, m = v; m < 0;) m += i;
                for (var g = Math.min(e.inHeight, s + v), y = 0; y < e.outWidth; ++y) {
                    for (var x = y * o - l, w = x; w < 0;) w += a;
                    for (var b = Math.min(e.inWidth, u + x), E = Number.NEGATIVE_INFINITY, C = -1, _ = m; _ < g; _ += i) for (var S = _ - v, R = w; R < b; R += a) {
                        var N = R - x, k = h.get(p, _, R, f);
                        E < k && (E = k, C = S * u + N)
                    }
                    n.set(C, p, d, y, f)
                }
            ...
            for (var o = this.maxPoolPositions(e, r), i = r.strideHeight, a = r.strideWidth, s = r.dilationHeight, u = r.dilationWidth, c = r.effectiveFilterHeight, l = r.effectiveFilterWidth, h = l - 1 - r.padInfo.left, p = c - 1 - r.padInfo.top, f = zi(e.shape, "float32"), d = o.bufferSync(), v = t.bufferSync(), m = 0; m < r.batchSize; ++m) for (var g = 0; g < r.inChannels; ++g) for (var y = 0; y < r.inHeight; ++y) for (var x = 0; x < r.inWidth; ++x) {
                for (var w = y - p, b = x - h, E = 0, C = 0; C < c; C += s) {
                    var _ = (w + C) / i;
                    if (!(_ < 0 || _ >= r.outHeight || Math.floor(_) !== _)) for (var S = 0; S < l; S += u) {
                        var R = (b + S) / a;
            ...
            for (var r = n.strideHeight, o = n.strideWidth, i = n.filterHeight, a = n.filterWidth, s = n.dilationHeight, u = n.dilationWidth, c = n.effectiveFilterHeight, l = n.effectiveFilterWidth, h = l - 1 - n.padInfo.left, p = c - 1 - n.padInfo.top, f = zi(e.shape, "float32"), d = 1 / (i * a), v = t.bufferSync(), m = 0; m < n.batchSize; ++m) for (var g = 0; g < n.inChannels; ++g) for (var y = 0; y < n.inHeight; ++y) for (var x = 0; x < n.inWidth; ++x) {
                for (var w = y - p, b = x - h, E = 0, C = 0; C < c; C += s) {
                    var _ = (w + C) / r;
                    if (!(_ < 0 || _ >= n.outHeight || Math.floor(_) !== _)) for (var S = 0; S < l; S += u) {
                        var R = (b + S) / o;
            ...
            for (var o = t.shape, i = o[0], a = o[1], s = o[2], u = o[3], c = t.dataSync(), l = new Float32Array(B([i, e, n, u])), h = [r && 1 < e ? a - 1 : a, r && 1 < n ? s - 1 : s], p = [r && 1 < e ? e - 1 : e, r && 1 < n ? n - 1 : n], f = 0, d = h[0] / p[0], v = h[1] / p[1], m = 0; m < i; m++) for (var g = 0; g < e; g++) for (var y = d * g, x = Math.floor(y), w = y - x, b = Math.min(a - 1, Math.ceil(y)), E = m * t.strides[0] + x * t.strides[1], C = m * t.strides[0] + b * t.strides[1], _ = 0; _ < n; _++) for (var S = v * _, R = Math.floor(S), N = S - R, k = Math.min(s - 1, Math.ceil(S)), I = E + R * t.strides[2], T = C + R * t.strides[2], A = E + +k * t.strides[2], D = C + k * t.strides[2], M = 0; M < u; M++) {
                var O = c[I + M], P = c[T + M], F = O + (c[A + M] - O) * N, L = F + (P + (c[D + M] - P) * N - F) * w;
                l[f++] = L
            }
            return Ge(l, [i, e, n, u])
        },t.prototype.resizeBilinearBackprop = function (t, e, n) {
            this.assertNotComplex([t, e], "resizeBilinearBackprop");
            for (var r = e.shape, o = r[0], i = r[1], a = r[2], s = r[3], u = t.shape, c = u[1], l = u[2], h = new Float32Array(o * i * a * s), p = [n && 1 < c ? i - 1 : i, n && 1 < l ? a - 1 : a], f = [n && 1 < c ? c - 1 : c, n && 1 < l ? l - 1 : l], d = p[0] / f[0], v = p[1] / f[1], m = t.dataSync(), g = 0, y = 0; y < o; y++) for (var x = y * e.strides[0], w = 0; w < c; w++) for (var b = w * d, E = Math.floor(b), C = Math.min(Math.ceil(b), i - 1), _ = x + E * e.strides[1], S = x + C * e.strides[1], R = b - E, N = 1 - R, k = 0; k < l; k++) for (var I = k * v, T = Math.floor(I), A = Math.min(Math.ceil(I), a - 1), D = I - T, M = 1 - D, O = _ + T * e.strides[2], P = _ + A * e.strides[2], F = S + T * e.strides[2], L = S + A * e.strides[2], B = N * M, W = N * D, z = R * M, U = R * D, G = 0; G < s; G++) {
                var V = m[g++];
            ...
            var s = t.shape[3], u = s - 1, c = t.dataSync(), o = t.size, i = new Float32Array(o);
            ...
            for (var h = 0; h < o; h++) {
                var p = l(h), f = c[h] * Math.pow(e + n * p, -r);
                i[h] = f
            }
            return $e(i, t.shape)
        },t.prototype.LRNGrad = function (t, e, n, r, o, i, a) {
            ...
            for (var o = e ? t : Le(t), i = o.shape[0], a = o.shape[1], s = Qe([i, n], "int32"), u = s.dataSync(), c = o.dataSync(), l = 0; l < i; ++l) {
                var h = l * a, p = new Float32Array(a - 1);
                p[0] = c[h];
            ...
            for (var n = t.shape[0], r = t.shape[1], o = zi(t.shape, "float32"), i = zi(t.shape, "float32"), a = ze(t).as2D(n, r), s = Ue(t).as2D(n, r), u = 0; u < n; u++) for (var c = a.slice([u, 0], [1, r]), l = s.slice([u, 0], [1, r]), h = We(c, l), p = this.fftImpl(h, e).dataSync(), f = 0; f < r; f++) {
                var d = cn(p, f);
            ...
            if (1 === e) return t;
            var r = t.dataSync(), o = e / 2, i = function (t) {
            ...
            }(r), a = We(i.real, i.imag).as1D(), s = function (t) {
            ...
            var c = function (t, e) {
                    ...
                    return {real: n, imag: r}
                }(e, n), l = We(c.real, c.imag).mul(u), h = a.add(l), p = a.sub(l), f = ze(h).concat(ze(p)),
                d = Ue(h).concat(Ue(p));
            return We(f, d).as1D()
            ...
            for (var r = t.shape[0], o = t.shape[1], i = t.shape[2], a = t.shape[3], s = o * e, u = i * e, c = a / (e * e), l = t.dataSync(), h = new Float32Array(r * s * u * c), p = 0, f = 0; f < r; ++f) for (var d = 0; d < s; ++d) for (var v = Math.floor(d / e), m = d % e, g = 0; g < u; ++g) for (var y = Math.floor(g / e), x = (m * e + g % e) * c, w = 0; w < c; ++w) {
                var b = w + x + a * (y + i * (v + o * f));
                h[p++] = l[b]
            }
            return $e(h, [r, s, u, c])
        },t.prototype.broadcastedBinaryOp = function (a, s, t, u) {
            var e = xn(a.shape, s.shape), c = zi(e, t), l = a.dataSync(), h = s.dataSync(), p = gn(a.shape, e),
                f = gn(s.shape, e), d = c.values;
            if (p.length + f.length === 0) for (var n = 0; n < d.length; ++n) d[n] = u(l[n % l.length], h[n % h.length]); else {
                var v = a.bufferSync(), m = s.bufferSync(), r = function (t) {
            ...
            var t = xn(s.shape, u.shape), l = zi(t, "float32"), e = zi(t, "float32"), h = s.dataSync(),
                p = u.dataSync(), f = gn(s.shape, t), d = gn(u.shape, t), v = l.values, m = e.values;
            if (f.length + d.length === 0) for (var n = 0; n < v.length; n++) {
                var r = n % h.length, o = n % p.length, i = c(h[2 * r], h[2 * r + 1], p[2 * o], p[2 * o + 1]);
                v[n] = i.real, m[n] = i.imag
            } else {
                var g = this.data.get(s.dataId).complexTensors.real.bufferSync(),
                    y = this.data.get(u.dataId).complexTensors.real.bufferSync(), a = function (t) {
                        ...
                        var i = y.locToIndex(o), a = c(h[2 * r], h[2 * r + 1], p[2 * i], p[2 * i + 1]);
            ...
            for (var a = t.shape, s = a[0], u = a[1], c = a[2], l = a[3], h = e.shape[0], p = r[0], f = r[1], d = zi([h, p, f, l], t.dtype), v = e.dataSync(), m = n.dataSync(), g = t.dataSync(), y = t.strides, x = d.strides, w = 0; w < h; w++) {
                var b = 4 * w, E = v[b], C = v[b + 1], _ = v[b + 2], S = v[b + 3], R = m[w];
                if (!(s <= R)) for (var N = 1 < p ? (_ - E) * (u - 1) / (p - 1) : 0, k = 1 < f ? (S - C) * (c - 1) / (f - 1) : 0, I = 0; I < p; I++) {
                    var T = 1 < p ? E * (u - 1) + I * N : .5 * (E + _) * (u - 1);
                    if (T < 0 || u - 1 < T) for (var A = 0; A < f; A++) for (var D = 0; D < l; D++) {
                        var M = D + A * x[2] + I * x[1] + w * x[0];
                        d.values[M] = i
                    } else if ("bilinear" === o) {
                        var O = Math.floor(T), P = Math.ceil(T), F = T - O;
                        for (A = 0; A < f; A++) if ((q = 1 < f ? C * (c - 1) + A * k : .5 * (C + S) * (c - 1)) < 0 || c - 1 < q) for (D = 0; D < l; D++) M = D + A * x[2] + I * x[1] + w * x[0], d.values[M] = i; else {
                            var L = Math.floor(q), B = Math.ceil(q), W = q - L;
                            for (D = 0; D < l; D++) {
                                var z = g[M = D + L * y[2] + O * y[1] + R * y[0]],
                                    U = g[M = D + B * y[2] + O * y[1] + R * y[0]],
                                    G = g[M = D + L * y[2] + P * y[1] + R * y[0]], V = z + (U - z) * W,
                        ...
                        var q;
                        if ((q = 1 < f ? C * (c - 1) + A * k : .5 * (C + S) * (c - 1)) < 0 || c - 1 < q) for (D = 0; D < l; D++) M = D + A * x[2] + I * x[1] + w * x[0], d.values[M] = i; else {
                            var j = Math.round(q), $ = Math.round(T);
                            for (D = 0; D < l; D++) {
                                var K = D + j * y[2] + $ * y[1] + R * y[0], X = D + A * x[2] + I * x[1] + w * x[0];
                                d.values[X] = g[K]
                            }
                        }
                    }
            ...
            var o = Te(0, t, n), i = o.sliceRank, a = o.numUpdates, s = o.sliceSize, u = o.strides, c = o.outputSize;
            ...
            var l = [r / o, o], h = t.dataSync(), p = e.dataSync();
    ...
    function jc(p, t) {
        for (var f = {}, d = 0, e = function (t) {
            var e = t.name, n = t.dtype, r = t.shape, o = B(r), i = void 0;
            if ("quantization" in t) {
                ...
                var s = qc[a.dtype], u = p.slice(d, d + o * s),
                ...
                var l = qc[n];
                if (u = p.slice(d, d + o * l), "float32" === n) i = new Float32Array(u); else if ("int32" === n) i = new Int32Array(u); else {
            ...
            var h = void 0;
            if ("float32" === n) h = Ge(i, r, "float32"); else if ("int32" === n) h = Ge(i, r, "int32"); else {
                if ("bool" !== n) throw new Error("Unsupported dtype in weight '" + e + "': " + n);
                h = Ge(i, r, "bool")
            }
            f[e] = h
    ...
    var rl = "tensorflowjs", ol = "models_store", il = "model_info_store";
    ...
    function al() {
        ...
        var t = window, e = t.indexedDB || t.mozIndexedDB || t.webkitIndexedDB || t.msIndexedDB || t.shimIndexedDB;
    ...
    function sl(t) {
        var e = t.result;
        e.createObjectStore(ol, {keyPath: "modelPath"}), e.createObjectStore(il, {keyPath: "modelPath"})
    }
        ...
        return t.prototype.save = function (e) {
            ...
            return new Promise(function (u, c) {
                ...
                l.onupgradeneeded = function () {
                    ...
                    var r = l.result;
                    if (null == h) {
                        var t = r.transaction(ol, "readonly"), e = t.objectStore(ol).get(p.modelPath);
                        ...
                        var o, i = Qc(h), a = r.transaction(il, "readwrite"), s = a.objectStore(il),
                ...
                return R(this, function (t) {
                    return [2, new Promise(function (i, n) {
                        ...
                        r.onupgradeneeded = function () {
                            ...
                            var e = r.result, t = e.transaction(il, "readonly"), o = t.objectStore(il).getAll();
                ...
                return R(this, function (t) {
                    return u = (e = u).startsWith(ul.URL_SCHEME) ? e.slice(ul.URL_SCHEME.length) : e, [2, new Promise(function (a, s) {
                        ...
                        e.onupgradeneeded = function () {
                            ...
                            var n, r = e.result, t = r.transaction(il, "readwrite"), o = t.objectStore(il),
                                i = o.get(u);
                            i.onsuccess = function () {
                                if (null == i.result) return r.close(), s(new Error("Cannot find model with path '" + u + "' in IndexedDB."));
                                var t = o.delete(u), e = function () {
    ...
    var hl = "/", pl = "tensorflowjs_models", fl = "info", dl = "model_topology", vl = "weight_specs",
        ml = "weight_data", gl = "model_metadata";
    ...
    var Cl = function () {
        ...
        return e.prototype.save = function (s) {
            return m(this, void 0, void 0, function () {
                var e, n, r, o, i, a;
                return R(this, function (t) {
                    if (e = window.URL.createObjectURL(new Blob([s.weightData], {type: "application/octet-stream"})), s.modelTopology instanceof ArrayBuffer) throw new Error("BrowserDownloads.save() does not support saving model topology in binary formats yet.");
                    return n = [{
                        ...
                        weightsManifest: n
                    }, o = window.URL.createObjectURL(new Blob([JSON.stringify(r)], {type: "application/json"})), (i = null == this.jsonAnchor ? document.createElement("a") : this.jsonAnchor).download = this.modelTopologyFileName, i.href = o, i.click(), null != s.weightData && ((a = null == this.weightDataAnchor ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName, a.href = e, a.click()), [2, {modelArtifactsInfo: Qc(s)}]
                })
            })
            ...
            return m(this, void 0, void 0, function () {
                ...
                return R(this, function (t) {
                    return r = this.files[0], h = this.files.slice(1), [2, new Promise(function (c, l) {
                        ...
                        t.onload = function (t) {
                            var e = JSON.parse(t.target.result), o = e.modelTopology;
                            if (null != o) {
                    ...
                    switch (t.label) {
                        case 0:
                            ...
                            return (e = Object.assign({method: this.DEFAULT_METHOD}, this.requestInit)).body = new FormData, n = [{
                                ...
                                convertedBy: i.convertedBy,
                                weightsManifest: n
                            }, e.body.append("model.json", new Blob([JSON.stringify(r)], {type: "application/json"}), "model.json"), null != i.weightData && e.body.append("model.weights.bin", new Blob([i.weightData], {type: "application/octet-stream"}), "model.weights.bin"), [4, this.getFetchFunc()(this.path, e)];
                        case 1:
                            if ((o = t.sent()).ok) return [2, {modelArtifactsInfo: Qc(i), responses: [o]}];
    ...
    var Dl = function () {
        ...
        return t.prototype.load = function () {
            return m(this, void 0, void 0, function () {
                var e;
                return R(this, function (t) {
                    return e = {}, null != this.modelTopology && (e = n({modelTopology: this.modelTopology}, e)), null != this.weightSpecs && 0 < this.weightSpecs.length && (e = n({weightSpecs: this.weightSpecs}, e)), null != this.weightData && 0 < this.weightData.byteLength && (e = n({weightData: this.weightData}, e)), [2, e]
                })
            })
        }, t
    }(), Ml = function () {
    ...
    var Ol = Object.freeze({
        browserFiles: function (t) {
            return new _l(t)
        }, browserHTTPRequest: Al, concatenateArrayBuffers: Xc, decodeWeights: jc, encodeWeights: function (i) {
            return m(this, void 0, void 0, function () {
                var e, n, r, o;
                return R(this, function (t) {
                    switch (t.label) {
                        case 0:
                            for (r in e = [], n = [], i) {
                                ...
                                e.push({name: r, shape: o.shape, dtype: o.dtype}), n.push(o.data())
                            }
        ...
        }, getModelArtifactsInfoForJSON: Qc, getSaveHandlers: function (t) {
            return Jc.getSaveHandlers(t)
        }, isHTTPScheme: Il, loadWeights: function (e, n, r, o) {
        ...
        }, weightsLoaderFactory: Nl, withSaveHandler: function (t) {
            return new Ml(t)
    ...
    var Pl = Fe({
        confusionMatrix_: function (t, e, n) {
            var r = re(t, "labels", "confusionMatrix"), o = re(e, "predictions", "confusionMatrix");
            ...
            var i = Yi(r.asType("int32"), n), a = Yi(o.asType("int32"), n);
    ...
    var Gl = Object.freeze({Serializable: Wl, SerializationMap: zl, registerClass: Ul});
    ...
    function Hl(t, e, n) {
        if (t instanceof dt || e instanceof dt) {
            ...
            var r = t.constructor.name, o = e.constructor.name;
    ...
    var jl = Object.freeze({
            ...
            expectValuesInRange: function (t, e, n) {
                ...
                for (var o = 0; o < r.length; o++) if (r[o] < e || r[o] > n) throw new Error("Value out of range:" + r[o] + " low: " + e + ", high: " + n)
            },
            expectArrayBuffersEqual: function (t, e) {
                expect(new Float32Array(t)).toEqual(new Float32Array(e))
            }
        }), $l = Object.freeze({gpgpu_util: Do, webgl_util: co, MathBackendWebGL: va, GPGPUContext: Mo}),
        Kl = function (t) {
            function e() {
    ...
    var Xl = function (o) {
        ...
        return s(t, o), t.prototype.applyGradients = function (t) {
            var c = this, e = function (o) {
                ...
                var a = t[o], s = n.accumulatedGrads[o], u = n.accumulatedUpdates[o];
                ue(function () {
    ...
    var Yl = function (r) {
        ...
        return s(t, r), t.prototype.applyGradients = function (t) {
            var a = this, e = function (n) {
                ...
                var o = t[n], i = s.accumulatedGrads[n];
                ue(function () {
    ...
    var Ql = function (i) {
        ...
        return s(t, i), t.prototype.applyGradients = function (f) {
            var d = this;
            ue(function () {
                var t = d.one.sub(d.accBeta1), e = d.one.sub(d.accBeta2);
                for (var n in f) {
                    var r = Zt.engine.registeredVariables[n];
                    ...
                    var i = f[n], a = d.accumulatedFirstMoment[n], s = d.accumulatedSecondMoment[n],
                        u = d.beta1Scalar.mul(a).add(d.oneMinusBeta1.mul(i)),
                        c = d.beta2Scalar.mul(s).add(d.oneMinusBeta2.mul(i.square())), l = u.div(t), h = c.div(e);
    ...
    var Jl = function (a) {
        ...
        return s(t, a), t.prototype.applyGradients = function (f) {
            var d = this;
            ue(function () {
                var t = d.one.sub(d.accBeta1), e = d.c.div(d.one.add(d.decayScalar.mul(d.iteration)));
                for (var n in f) {
                    var r = Zt.engine.registeredVariables[n];
                    if (null == d.accumulatedFirstMoment[n]) {
                        var o = !1;
                    ...
                    var i = f[n], a = d.accumulatedFirstMoment[n], s = d.accumulatedWeightedInfNorm[n],
                        u = d.beta1Scalar.mul(a).add(d.oneMinusBeta1.mul(i)), c = d.beta2Scalar.mul(s), l = i.abs(),
                        h = c.maximum(l);
    ...
    var Zl = function (n) {
        ...
        return s(t, n), t.prototype.applyGradients = function (r) {
            ...
            Object.keys(r).forEach(function (t) {
                var e = r[t], n = Zt.engine.registeredVariables[t];
                ue(function () {
    ...
    var th = function (o) {
        ...
        return s(t, o), t.prototype.applyGradients = function (t) {
            ...
            if (o.prototype.dispose.call(this), this.m.dispose(), null != this.accumulations) for (var t in this.accumulations) this.accumulations[t].dispose()
    ...
    var eh = function (a) {
        ...
        return s(t, a), t.prototype.applyGradients = function (t) {
            var h = this, e = function (i) {
                ...
                var s = n.accumulatedMeanSquares[i], u = n.accumulatedMeanGrads[i], c = n.accumulatedMoments[i],
                    l = t[i];
                ue(function () {
    ...
    var nh = function () {
        ...
        adamax: nh.adamax,
        adam: nh.adam
    }, oh = jt.setBackend, ih = jt.getBackend, ah = jt.disposeVariables, sh = jt.memory;
    pt = Gc;
    var uh = Object.freeze({
        ...
        grad: function (i) {
            return D(j(i), function () {
                ...
                var r = re(t, "x", "tf.grad", null), o = null != e ? re(e, "dy", "tf.grad") : null;
        ...
        grads: function (i) {
            return D(j(i), function () {
                ...
                var r = oe(t, "args", "tf.grads", null), o = null != e ? re(e, "dy", "tf.grads") : null;
                return Zt.engine.tidy(function () {
                    var t = Zt.engine.gradients(function () {
    ...
    var _h, Sh = function () {
        function l(t, e) {
            void 0 === e && (e = !0);
            var n = t || {}, r = [n.left, n.top, n.right, n.bottom].every(Eh),
        ...
        return l.isRect = function (t) {
            ...
            var e = yh(t) ? t.width : t, n = yh(t) ? t.height : t;
            return new l({x: this.x * e, y: this.y * n, width: this.width * e, height: this.height * n})
            ...
            var n = this.x, r = this.y, o = this.right, i = this.bottom, a = Math.max(n, 0), s = Math.max(r, 0),
                u = o - a, c = i - s;
            return new l({x: a, y: s, width: Math.min(u, t - a), height: Math.min(c, e - s)}).floor()
        ...
        function t(t, e, n, r, o) {
            return void 0 === o && (o = !1), i.call(this, {left: t, top: e, right: n, bottom: r}, o) || this
        }
        ...
        return Object.defineProperty(n.prototype, "score", {
            ...
            return new n(this.score, this.classScore, this.className, this.relativeBox, {width: t, height: e})
        }, n
    }(), Ih = function (i) {
        function t(t, e, n, r) {
        ...
        function t(t, e, n, r, o) {
            return void 0 === o && (o = !1), i.call(this, {x: t, y: e, width: n, height: r}, o) || this
        }
    ...
    var Bh, Wh, zh = {
        ...
        monkeyPatch: function (t) {
            ...
            var e = t.Canvas, n = void 0 === e ? _h.Canvas : e, r = t.Image, o = void 0 === r ? _h.Image : r;
    ...
    var Vh = function (t) {
        ...
        return r.prototype.measureWidth = function (e) {
            ...
            var n = this.options.anchorPosition, r = n === Bh.BOTTOM_RIGHT || n === Bh.TOP_RIGHT,
                o = n === Bh.BOTTOM_LEFT || n === Bh.BOTTOM_RIGHT, i = this.measureWidth(t), a = this.measureHeight(),
            ...
            var e = Uh(t), o = Gh(e), n = this.options, r = n.backgroundColor, i = n.fontColor, a = n.fontSize,
        ...
        var i = {anchorPosition: Bh.BOTTOM_LEFT, backgroundColor: this.boxColor};
        ...
        return t.prototype.draw = function (t) {
            var e = Gh(t), n = this.options, r = n.boxColor, o = n.lineWidth, i = this.box, a = i.x, s = i.y,
                u = i.width, c = i.height;
            e.strokeStyle = r, e.lineWidth = o, e.strokeRect(a, s, u, c);
            var l = this.options.label;
            l && new Hh([l], {x: a - o / 2, y: s}, this.options.drawLabelOptions).draw(t)
        }, t
    }(), $h = Object.freeze({
        DrawBoxOptions: qh, DrawBox: jh, get AnchorPosition() {
            return Bh
        }, DrawTextFieldOptions: Vh, DrawTextField: Hh
    });
    ...
    function Yh(a, s) {
        return function (t, e, n, r) {
            var o = $e(a(t * e * n * n), [n, n, t, e]), i = He(a(e));
    ...
    function Zh(a, s) {
        return function (t, e, n) {
            var r = $e(a(9 * t), [3, 3, t, 1]), o = $e(a(t * e), [1, 1, t, e]), i = He(a(e));
            return s.push({paramPath: n + "/depthwise_filter"}, {paramPath: n + "/pointwise_filter"}, {paramPath: n + "/bias"}), new Jh(r, o, i)
        }
    }
    ...
    function op(t) {
        var e = zh.getEnv(), n = e.Image, r = e.Video;
    ...
    function up(t) {
        var e = t.width, n = t.height, r = (0, zh.getEnv().createCanvasElement)();
    ...
    function cp(t, e) {
        ...
        var r = e || sp(t), o = r.width, i = r.height, a = up({width: o, height: i});
    ...
    function fp(t, e, n) {
        void 0 === n && (n = !1);
        var r = zh.getEnv(), o = r.Image, i = r.Canvas;
        if (!(t instanceof o || t instanceof i)) throw new Error("imageToSquare - expected arg0 to be HTMLImageElement | HTMLCanvasElement");
        var a = sp(t), s = e / Math.max(a.height, a.width), u = s * a.width, c = s * a.height,
            l = up({width: e, height: e}), h = t instanceof i ? t : cp(t), p = Math.abs(u - c) / 2,
            f = n && u < c ? p : 0, d = n && c < u ? p : 0;
        return Gh(l).drawImage(h, f, d, u, c), l
    }

    function dp(t) {
        var e = zh.getEnv(), n = e.Image, r = e.Canvas, o = e.Video;
    ...
    function mp(l, h) {
        return void 0 === h && (h = !1), ue(function () {
            ...
            if (e === n) return l;
            var r = Math.abs(e - n), o = Math.round(r * (h ? .5 : 1)), i = n < e ? 2 : 1, a = function (t) {
                var e = l.shape.slice();
                return e[i] = t, Je(e, 0)
            }, s = a(o), u = r - s.shape[i], c = [h && u ? a(u) : null, l, s].filter(function (t) {
                return !!t
            }).map(function (t) {
                return t.toFloat()
            });
    ...
    var gp = function () {
        ...
        return Object.defineProperty(t.prototype, "imageTensors", {
            ...
            return xh({width: this.getInputWidth(t), height: this.getInputHeight(t)}, this.inputSize)
    ...
    var xp = function () {
        ...
        return Object.defineProperty(t.prototype, "params", {
            ...
            this.getTrainableParams().forEach(function (t) {
                var e = t.path, n = t.tensor, r = Ge(n.dataSync());
    ...
    function Ep(s, u) {
        return ue(function () {
            var t = u[0], e = u[1], n = u[2], r = Je(s.shape.slice(0, 3).concat([1]), t),
                o = Je(s.shape.slice(0, 3).concat([1]), e), i = Je(s.shape.slice(0, 3).concat([1]), n),
                a = _i([r, o, i], 3);
            return Bu(s, a)
        })
    }
    ...
    function Ap(s, u) {
        ...
        var t = Zh(s, u);
        return {
            extractConvParams: c, extractConvWithBatchNormParams: function (t, e, n) {
                var r, o, i, a;
                return {
                    conv: c(t, e, 3, n + "/conv"),
                    bn: (o = n + "/bn", i = He(s(r = e)), a = He(s(r)), u.push({paramPath: o + "/sub"}, {paramPath: o + "/truediv"}), {
                        sub: i,
                        truediv: a
                    })
                }
    ...
    var Mp = function () {
        ...
        return a(r, n), Object.defineProperty(r.prototype, "config", {
            ...
            return function (t, e) {
                var n, r = [], o = Dp(t, r), i = o.extractConvParams, a = o.extractConvWithBatchNormParams,
            ...
            var e = this.config.filterSizes || r.DEFAULT_FILTER_SIZES, n = e ? e.length : void 0;
            if (7 !== n && 8 !== n && 9 !== n) throw new Error("TinyYolov2 - expected 7 | 8 | 9 convolutional filters, but found " + n + " filterSizes in config");
            return function (t, e, n, r) {
                var o, i = np(t), a = i.extractWeights, s = i.getRemainingWeights, u = [], c = Ap(a, u),
                    l = c.extractConvParams, h = c.extractConvWithBatchNormParams, p = c.extractSeparableConvParams;
                if (e.withSeparableConvs) {
                    var f = r[0], d = r[1], v = r[2], m = r[3], g = r[4], y = r[5], x = r[6], w = r[7], b = r[8];
                    o = {
    ...
    function Up(r, o, i) {
        return void 0 === i && (i = !1), ue(function () {
            var t = Xu(i ? xu(Ss(r, o.conv0.filters, [2, 2], "same"), o.conv0.bias) : zp(r, o.conv0, [2, 2])),
                e = zp(t, o.conv1, [1, 1]), n = zp(Xu(xu(t, e)), o.conv2, [1, 1]);
    ...
    function Gp(o, i, a, s) {
        return void 0 === a && (a = !1), void 0 === s && (s = !0), ue(function () {
            var t = Xu(a ? xu(Ss(o, i.conv0.filters, s ? [2, 2] : [1, 1], "same"), i.conv0.bias) : zp(o, i.conv0, s ? [2, 2] : [1, 1])),
                e = zp(t, i.conv1, [1, 1]), n = zp(Xu(xu(t, e)), i.conv2, [1, 1]),
    ...
    var jp = function (t) {
        ...
        return a(e, t), e.prototype.forwardInput = function (e) {
            ...
            return r = qp(e = t, n = []).extractDenseBlock4Params, o = {
                ...
                dense2: r("dense2"),
                dense3: r("dense3")
            }, Xh(e, n), {params: o, paramMappings: n};
            var e, n, r, o
        }, e.prototype.extractParams = function (t) {
            return function (t) {
                var e = [], n = np(t), r = n.extractWeights, o = n.getRemainingWeights,
                    i = Vp(r, e).extractDenseBlock4Params, a = i(3, 32, "dense0", !0), s = i(32, 64, "dense1"),
    ...
    var Xp = function (r) {
        ...
        return a(t, r), Object.defineProperty(t.prototype, "faceFeatureExtractor", {
            ...
            return function (t, e, n) {
                var r = [], o = np(t), i = o.extractWeights, a = o.getRemainingWeights, s = Qh(i, r)(e, n, "fc");
            ...
            var e, n, r, o, i, a = Kp(t), s = a.featureExtractorMap, u = a.classifierMap;
            return this.faceFeatureExtractor.loadFromWeightMap(s), o = ep(e = u, r = []), i = {
                fc: (n = "fc", {
                    weights: o(n + "/weights", 2),
                    bias: o(n + "/bias", 1)
                })
            }, Xh(e, r), {params: i, paramMappings: r}
    ...
    }(xp), Yp = ["neutral", "happy", "sad", "angry", "fearful", "disgusted", "surprised"], Qp = function () {
        function t(n) {
            var r = this;
    ...
    var ef = function () {
        ...
        return Object.defineProperty(t.prototype, "shift", {
            ...
            var t = this.getRefPointsForAlignment(), e = t[0], n = t[1], r = t[2], o = function (t) {
                    return r.sub(t).magnitude()
                }, i = (o(e) + o(n)) / 2, a = Math.floor(i / .45), s = wh(t), u = Math.floor(Math.max(0, s.x - .5 * a)),
    ...
    var af = function (t) {
        ...
        return t.prototype.draw = function (t) {
            var e = Gh(t), n = this.options, r = n.drawLines, o = n.drawPoints, i = n.lineWidth, a = n.lineColor,
    ...
    var uf = Object.freeze({
        drawContour: Fp, drawDetections: function (o, t) {
            (Array.isArray(t) ? t : [t]).forEach(function (t) {
                var e = t instanceof Lp ? t.score : Bp(t) ? t.detection.score : void 0,
                    n = t instanceof Lp ? t.box : Bp(t) ? t.detection.box : new Sh(t), r = e ? "" + gh(e) : void 0;
        ...
        }, DrawFaceLandmarksOptions: af, DrawFaceLandmarks: sf, drawFaceLandmarks: function (n, t) {
            (Array.isArray(t) ? t : [t]).forEach(function (t) {
    ...
    function cf(t, e) {
        var n, r, o, i, a = [], s = np(t), u = s.extractWeights, c = s.getRemainingWeights,
            ...
            }), h = l.extractSeparableConvParams, p = l.extractReductionBlockParams, f = l.extractMainBlockParams, d = {
        ...
        return {paramMappings: a, params: {entry_flow: d, middle_flow: v, exit_flow: m}}
    }

    function lf(t, e) {
        var n, r, o, i = [], a = (n = ep(t, i), r = Hp(n), o = tp(n), {
            extractConvParams: r,
        ...
        var p = {reduction_block: u("exit_flow/reduction_block"), separable_conv: s("exit_flow/separable_conv")};
        return Xh(t, i), {params: {entry_flow: l, middle_flow: h, exit_flow: p}, paramMappings: i}
    }
    ...
    var vf = function (n) {
        ...
        return a(t, n), Object.defineProperty(t.prototype, "faceFeatureExtractor", {
            ...
            return function (t) {
                var e = [], n = np(t), r = n.extractWeights, o = n.getRemainingWeights, i = Qh(r, e),
                    a = i(512, 1, "fc/age"), s = i(512, 2, "fc/gender");
                if (0 !== o().length) throw new Error("weights remaing after extract: " + o().length);
                return {paramMappings: e, params: {fc: {age: a, gender: s}}}
            }(t)
        }, t.prototype.extractParamsFromWeigthMap = function (t) {
            var e = Kp(t), n = e.featureExtractorMap, r = e.classifierMap;
                ...
                switch (t.label) {
                    ...
                    case 5:
                        return a = Gh(n), [2, u.map(function (t) {
                            ...
                            var e = t.x, n = t.y, r = t.width, o = t.height, i = up({width: r, height: o});
        ...
        return p(this, void 0, void 0, function () {
            return P(this, function (t) {
                ...
                return [2, ue(function () {
                    var t = u.shape.slice(dh(u) ? 1 : 0), i = t[0], a = t[1], s = t[2];
    ...
    var Cf = function (t) {
        ...
        return a(e, t), e.prototype.forwardInput = function (e) {
            ...
            return function (t) {
                var e = [], n = np(t), r = n.extractWeights, o = n.getRemainingWeights,
                    i = Vp(r, e).extractDenseBlock3Params, a = i(3, 32, "dense0", !0), s = i(32, 64, "dense1"),
                    u = i(64, 128, "dense2");
                if (0 !== o().length) throw new Error("weights remaing after extract: " + o().length);
    ...
    function Rf(t, e, n, r, o) {
        void 0 === o && (o = "same");
        var i, a, s = e.conv, u = s.filters, c = s.bias, l = Ss(t, u, n, o);
    ...
    function If(u, c) {
        ...
        function i(t, e, n, r) {
            ...
            return {
                conv: l(t, e, n, r + "/conv"),
                scale: (i = r + "/scale", a = He(u(o = e)), s = He(u(o)), c.push({paramPath: i + "/weights"}, {paramPath: i + "/biases"}), {
                    weights: a,
                    biases: s
                })
            }
    ...
    function Tf(t, e) {
        ...
        function r(t) {
            ...
            return {
                ...
                scale: {weights: n((e = t) + "/scale/weights", 1), biases: n(e + "/scale/biases", 1)}
            }
        }
    ...
    function Df(t, e) {
        var n = kf(t, e.conv1);
        n = Nf(n, e.conv2);
        var r = Gs(t, 2, 2, "valid"), o = Qe(r.shape), i = r.shape[3] !== n.shape[3];
        if (r.shape[1] !== n.shape[1] || r.shape[2] !== n.shape[2]) {
            var a = n.shape.slice();
            a[1] = 1;
            var s = Qe(a), u = (n = _i([n, s], 1)).shape.slice();
            u[2] = 1;
            var c = Qe(u);
            n = _i([n, c], 2)
        }
    ...
    var Mf = function (t) {
        ...
        return a(e, t), e.prototype.forwardInput = function (n) {
            ...
            return function (t) {
                var e = [], n = Tf(t, e), r = n.extractConvLayerParams, o = n.extractResidualLayerParams,
                    i = r("conv32_down"), a = o("conv32_1"), s = o("conv32_2"), u = o("conv32_3"), c = o("conv64_down"),
                    l = o("conv64_1"), h = o("conv64_2"), p = o("conv64_3"), f = o("conv128_down"), d = o("conv128_1"),
                    v = o("conv128_2"), m = o("conv256_down"), g = o("conv256_1"), y = o("conv256_2"),
                    x = o("conv256_down_out"), w = t.fc;
                if (e.push({
                    originalPath: "fc",
                    paramPath: "fc"
            ...
            return function (t) {
                var e = np(t), n = e.extractWeights, r = e.getRemainingWeights, o = [], i = If(n, o),
                    ...
                    p = s(36864, 64, 3, "conv64_down", !0), f = s(36864, 64, 3, "conv64_1"),
                    ...
                    w = s(589824, 256, 3, "conv256_1"), b = s(589824, 256, 3, "conv256_2"),
                    E = s(589824, 256, 3, "conv256_down_out"), C = ue(function () {
    ...
    var Pf = function () {
        function t(t) {
            var e = void 0 === t ? {} : t, n = e.minFaceSize, r = e.scaleFactor, o = e.maxNumScales,
                i = e.scoreThresholds, a = e.scaleSteps;
    ...
    function Ff(l, h) {
        function i(t, e, n, r, o) {
            var i = $e(l(t * e * n * n), [n, n, t, e]), a = He(l(e));
            return h.push({paramPath: r + "/filters"}, {paramPath: r + "/" + (o ? "batch_norm_offset" : "bias")}), {
                filters: i,
                bias: a
            }
        }
        ...
        function t(t, e, n) {
            var r, o, i, a, s, u, c;
            return {
                depthwise_conv: (o = n + "/depthwise_conv", i = $e(l(9 * (r = t)), [3, 3, r, 1]), a = He(l(r)), s = He(l(r)), u = He(l(r)), c = He(l(r)), h.push({paramPath: o + "/filters"}, {paramPath: o + "/batch_norm_scale"}, {paramPath: o + "/batch_norm_offset"}, {paramPath: o + "/batch_norm_mean"}, {paramPath: o + "/batch_norm_variance"}), {
                    filters: i,
                    batch_norm_scale: a,
                    batch_norm_offset: s,
                    batch_norm_mean: u,
    ...
    function zf(t, e) {
        return ue(function () {
            var u = null, c = Bf(t, e.conv_0, [2, 2]);
            if ([e.conv_1, e.conv_2, e.conv_3, e.conv_4, e.conv_5, e.conv_6, e.conv_7, e.conv_8, e.conv_9, e.conv_10, e.conv_11, e.conv_12, e.conv_13].forEach(function (t, e) {
                var n, r, o, i, a = e + 1, s = (n = a, [2, 4, 6, 12].some(function (t) {
                    return t === n
                }) ? [2, 2] : [1, 1]);
    ...
    function Gf(t, e) {
        var n, r, o = (n = ha(Qu(t, [1, 0])), {
            ...
            }), i = o.sizes, a = o.centers, s = ha(Qu(e, [1, 0])), u = Cu(Du(Ia(Cu(s[2], Ve(5))), i[0]), Ve(2)),
            c = xu(Du(Cu(s[0], Ve(10)), i[0]), a[0]), l = Cu(Du(Ia(Cu(s[3], Ve(5))), i[1]), Ve(2)),
        ...
        return a(e, t), e.prototype.forwardInput = function (u) {
            ...
            return ue(function () {
                var l, h, p, o, i, a, t = u.toBatchTensor(512, !1).toFloat(),
                    ...
                    n = (l = e.out, h = e.conv11, p = c.prediction_layer, ue(function () {
                        var t = Bf(Bf(l, p.conv_0, [1, 1]), p.conv_1, [2, 2]),
                            ...
                            r = Bf(Bf(n, p.conv_6, [1, 1]), p.conv_7, [2, 2]), o = Vf(h, p.box_predictor_0),
                            i = Vf(l, p.box_predictor_1), a = Vf(t, p.box_predictor_2), s = Vf(e, p.box_predictor_3),
                            u = Vf(n, p.box_predictor_4), c = Vf(r, p.box_predictor_5);
                        return {
                ...
                return o = r, i = s, a = c.output_layer, ue(function () {
                    var t = o.shape[0], e = Gf(ia(ca(a.extra_dim, [t, 1, 1]), [-1, 4]), ia(o, [-1, 4]));
                    e = ia(e, [t, e.shape[0] / t, 4]);
                    var n = Wa(Hs(i, [0, 0, 1], [-1, -1, -1])), r = Hs(n, [0, 0, 0], [-1, -1, 1]);
                    return r = ia(r, [t, r.shape[1]]), {boxes: ha(e), scores: ha(r)}
                })
            })
        }, e.prototype.forward = function (n) {
            return p(this, void 0, void 0, function () {
            ...
            return function (t) {
                var e = [], n = np(t), r = n.extractWeights, o = n.getRemainingWeights, i = Ff(r, e),
    ...
    function td(t) {
        var e = np(t), n = e.extractWeights, r = e.getRemainingWeights, o = [], i = function (r, o) {
            var u = Yh(r, o), c = Qh(r, o);
            ...
            return {
                extractPNetParams: function () {
                    ...
                    return O({}, t, {conv4: e, prelu4_alpha: n, fc1: r, prelu5_alpha: o, fc2_1: i, fc2_2: a, fc2_3: s})
                }
            }
    ...
    function ed(t) {
        ...
        return Xh(t, e), {params: {pnet: a, rnet: s, onet: u}, paramMappings: e}
    }
    ...
    function sd(h, t, u, p, c) {
        ...
        var e = t.map(function (l) {
            return ue(function () {
                var o, i, r, a, t = {scale: l}, e = (o = h, i = l, ue(function () {
                    var t = nd(i, o.shape.slice(1)), e = t.height, n = t.width, r = od(Wc.resizeBilinear(o, [e, n]));
                    return Qu(r, [0, 2, 1, 3])
                })), n = Date.now(), s = (r = e, a = p, ue(function () {
                    var t = ad(r, a, !0), e = Kh(t, a.conv4_1, "valid"), n = $i(eu(e, 3), 3);
                    return {prob: Le(Bu(e, n), 3), regions: Kh(t, a.conv4_2, "valid")}
            ...
            var e = t.scoresTensor, n = t.regionsTensor, r = t.scale, o = t.statsForScale, i = function (t, o, i, e) {
                for (var n = [], a = t.arraySync(), r = 0; r < t.shape[0]; r++) for (var s = 0; s < t.shape[1]; s++) a[r][s] >= e && n.push(new lh(s, r));
            ...
            var a = Date.now(), s = bp(i.map(function (t) {
                return t.cell
            }), i.map(function (t) {
                return t.score
            }), .5);
        ...
        if (0 < e.length) {
            var o = Date.now(), i = bp(e.map(function (t) {
                return t.cell
            }), e.map(function (t) {
                return t.score
            }), .7);
                        ...
                        return n = t.sent(), x.stage2_extractImagePatches = Date.now() - e, e = Date.now(), r = n.map(function (t) {
                            var a, s, e = (a = t, s = y, ue(function () {
                                var t = ad(a, s),
                                    ...
                                    n = $p(e, s.fc2_1), r = $i(eu(n, 1), 1), o = Le(Bu(n, r), 1), i = $p(e, s.fc2_2);
                        ...
                        return n = t.sent(), w.stage3_extractImagePatches = Date.now() - e, e = Date.now(), i = n.map(function (t) {
                            var s, u, e = (s = t, u = x, ue(function () {
                                ...
                                var e = id($p(ia(t, [t.shape[0], u.fc1.weights.shape[0]]), u.fc1), u.prelu5_alpha),
                                    n = $p(e, u.fc2_1), r = $i(eu(n, 1), 1), o = Le(Bu(n, r), 1), i = $p(e, u.fc2_2),
                                    a = $p(e, u.fc2_3);
    ...
    var hd = function (t) {
        ...
        fd = [117.001, 114.697, 97.404], dd = function (e) {
            function t() {
                var t = {
                        ...
                        switch (t.label) {
                            ...
                            case 1:
                                return [2, t.sent().map(function (t) {
                                    return new Lp(t.score, t.relativeBox, {width: t.imageWidth, height: t.imageHeight})
                                })]
                        }
                    })
                })
        ...
        gd = [117.001, 114.697, 97.404], yd = function (n) {
            function t(t) {
                void 0 === t && (t = !0);
    ...
    var kd = function (o) {
                ...
                return P(this, function (t) {
                    switch (t.label) {
                        case 0:
                            return [4, this.parentTask];
                        case 1:
                            return [4, Yf(n = t.sent(), this.input, function (t) {
                                return Promise.all(t.map(function (t) {
        ...
        return a(t, o), Object.defineProperty(t.prototype, "landmarkNet", {
            get: function () {
                return this.useTinyLandmarkNet ? xd.faceLandmark68TinyNet : xd.faceLandmark68Net
            }, enumerable: !0, configurable: !0
        }), t
    }(Xf), Gd = function (t) {
        function e() {
                ...
                return P(this, function (t) {
                    switch (t.label) {
                        case 0:
                            return [4, this.parentTask];
                        case 1:
                            return (e = t.sent()) ? (n = e.detection, this.input instanceof dt ? [4, wf(this.input, [n])] : [3, 3]) : [2];
                        case 2:
                            return o = t.sent(), [3, 5];
                        case 3:
                            return [4, xf(this.input, [n])];
        ...
        return a(e, t), e.prototype.run = function () {
            return p(this, void 0, void 0, function () {
                ...
                return P(this, function (t) {
                    switch (t.label) {
                        case 0:
                            return n = (e = this).input, (r = e.options) instanceof Pf ? [4, xd.mtcnn.forward(n, r)] : [3, 2];
                        case 1:
                            return [2, t.sent().map(function (t) {
                                return t.detection
                            })];
                        case 2:
                            if (!(o = r instanceof Kf ? function (t) {
                                return xd.tinyFaceDetector.locateFaces(t, r)
                            } : r instanceof Hf ? function (t) {
                                return xd.ssdMobilenetv1.locateFaces(t, r)
                            } : r instanceof Mp ? function (t) {
            ...
            return void 0 === t && (t = !1), new Gd(this.runAndExtendWithFaceDetections(), this.input, t)
        }, e.prototype.withFaceExpressions = function () {
        ...
        return a(e, t), e.prototype.run = function () {
            ...
            return void 0 === t && (t = !1), new Vd(this.runAndExtendWithFaceDetection(), this.input, t)
        }, e.prototype.withFaceExpressions = function () {
    ...
    function Kd(e, n) {
        return p(this, void 0, void 0, function () {
            return P(this, function (t) {
                switch (t.label) {
                    case 0:
                        return [4, $d(e, new Hf(n ? {minConfidence: n} : {})).withFaceLandmarks().withFaceDescriptors()];
                    case 1:
                        return [2, t.sent()]
                }
            })
    ...
    var Qd = function () {
        function t(t, e) {
            ...
            this._labeledDescriptors = n.map(function (t) {
                ...
                if (t.descriptor && t.descriptor instanceof Float32Array) return new yf(o(), [t.descriptor]);
    ...
    c.AgeGenderNet = vf, c.BoundingBox = Rh, c.Box = Sh, c.ComposableTask = Xf, c.ComputeAllFaceDescriptorsTask = Wd, c.ComputeFaceDescriptorsTaskBase = Bd, c.ComputeSingleFaceDescriptorTask = zd, c.DetectAllFaceLandmarksTask = Gd, c.DetectAllFacesTask = qd, c.DetectFaceLandmarksTaskBase = Ud, c.DetectFacesTaskBase = Hd, c.DetectSingleFaceLandmarksTask = Vd, c.DetectSingleFaceTask = jd, c.Dimensions = ch, c.FACE_EXPRESSION_LABELS = Yp, c.FaceDetection = Lp, c.FaceDetectionNet = $f, c.FaceExpressionNet = Jp, c.FaceExpressions = Qp, c.FaceLandmark68Net = Ef, c.FaceLandmark68TinyNet = _f, c.FaceLandmarkNet = Sf, c.FaceLandmarks = ef, c.FaceLandmarks5 = mf, c.FaceLandmarks68 = nf, c.FaceMatch = gf, c.FaceMatcher = Qd, c.FaceRecognitionNet = Mf, c.LabeledBox = Nh, c.LabeledFaceDescriptors = yf, c.Mtcnn = hd, c.MtcnnOptions = Pf, c.NetInput = gp, c.NeuralNetwork = xp, c.ObjectDetection = kh, c.Point = lh, c.PredictedBox = Ih, c.Rect = Th, c.SsdMobilenetv1 = qf, c.SsdMobilenetv1Options = Hf, c.TfjsImageRecognitionBase = Pp, c.TinyFaceDetector = dd, c.TinyFaceDetectorOptions = Kf, c.TinyYolov2 = yd, c.allFaces = Xd, c.allFacesMtcnn = function (e, n) {
        ...
        var e = new hd;
        return e.extractWeights(t), e
    }, c.createSsdMobilenetv1 = jf, c.createTinyFaceDetector = function (t) {
        var e = new dd;
        return e.extractWeights(t), e
    ...
    }, c.detectAllFaces = $d, c.detectFaceLandmarks = bd, c.detectFaceLandmarksTiny = function (t) {
        return xd.faceLandmark68TinyNet.detectLandmarks(t)
    }, c.detectLandmarks = Sd, c.detectSingleFace = function (t, e) {
        return void 0 === e && (e = new Hf), new jd(t, e)
    }, c.draw = Jd, c.env = zh, c.euclideanDistance = Yd, c.extendWithFaceDescriptor = Of, c.extendWithFaceDetection = Wp, c.extendWithFaceExpressions = tf, c.extendWithFaceLandmarks = of, c.extractFaceTensors = wf, c.extractFaces = xf, c.fetchImage = function (r) {
        return p(this, void 0, void 0, function () {
            var e, n;
            return P(this, function (t) {
                switch (t.label) {
    ...
    }, c.fetchJson = hp, c.fetchNetWeights = function (n) {
        return p(this, void 0, void 0, function () {
            var e;
            return P(this, function (t) {
                switch (t.label) {
    ...
    }, c.fetchOrThrow = lp, c.getCenterPoint = wh, c.getContext2dOrThrow = Gh, c.getMediaDimensions = sp, c.imageTensorToCanvas = pp, c.imageToSquare = fp, c.inverseSigmoid = function (t) {
        return Math.log(t / (1 - t))
    }, c.iou = wp, c.isDimensions = yh, c.isEven = mh, c.isFloat = vh, c.isMediaElement = dp, c.isMediaLoaded = op, c.isTensor = hh, c.isTensor1D = function (t) {
        return hh(t, 1)
    }, c.isTensor2D = ph, c.isTensor3D = fh, c.isTensor4D = dh, c.isValidNumber = Eh, c.isValidProbablitiy = Ch, c.isWithFaceDetection = Bp, c.isWithFaceExpressions = Zp, c.isWithFaceLandmarks = rf, c.loadAgeGenderModel = function (t) {
        return xd.ageGenderNet.load(t)
    },c.loadFaceDetectionModel = Cd,c.loadFaceExpressionModel = function (t) {
    ...
    },c.loadSsdMobilenetv1Model = Ed,c.loadTinyFaceDetectorModel = function (t) {
        return xd.tinyFaceDetector.load(t)
    },c.loadTinyYolov2Model = function (t) {
        return xd.tinyYolov2.load(t)
    },c.loadWeightMap = vp,c.locateFaces = _d,c.matchDimensions = function (t, e, n) {
        void 0 === n && (n = !1);
        var r = n ? sp(e) : e, o = r.width, i = r.height;
        return {width: t.width = o, height: t.height = i}
    },c.mtcnn = function (t, e) {
        return xd.mtcnn.forward(t, e)
    },c.nets = xd,c.nonMaxSuppression = bp,c.normalize = Ep,c.padToSquare = mp,c.predictAgeAndGender = function (t) {
        return xd.ageGenderNet.predictAgeAndGender(t)
    },c.range = bh,c.recognizeFaceExpressions = function (t) {
        return xd.faceExpressionNet.predictExpressions(t)
    },c.resizeResults = function e(t, n) {
        var r = new ch(n.width, n.height), o = r.width, i = r.height;
        ...
        return Bp(t) ? Wp(t, t.detection.forSize(o, i)) : t instanceof ef || t instanceof Lp ? t.forSize(o, i) : t
    },c.resolveInput = Uh,c.round = gh,c.shuffleArray = function (t) {
        for (var e = t.slice(), n = e.length - 1; 0 < n; n--) {
            var r = Math.floor(Math.random() * (n + 1)), o = e[n];
            e[n] = e[r], e[r] = o
        }
        return e
    },c.sigmoid = Cp,c.ssdMobilenetv1 = wd,c.tf = uh,c.tinyFaceDetector = function (t, e) {
        return xd.tinyFaceDetector.locateFaces(t, e)
    },c.tinyYolov2 = function (t, e) {
        return xd.tinyYolov2.locateFaces(t, e)
    },c.toNetInput = yp,Object.defineProperty(c, "__esModule", {value: !0})
});
